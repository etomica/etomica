 ...
 */
public class DataSourceGC extends AtomActionAdapter implements DataSource, AtomPositionDefinition {

    public DataSourceGC(Space space) {
        this.space = space;
    ...
    public Vector getCOM() {
    	com.Ea1Tv1(1.0 / natoms, vectorSum);
        return com;
    }
