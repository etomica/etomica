...
//Display to see adjusted temperature
	...
	sim.accumulator1.addDataSink(profilePlot.getDataTable(),new AccumulatorAverage.StatType[]{AccumulatorAverage.StatType.AVERAGE});
    sim.accumulator2.addDataSink(profilePlot.getDataTable(),new AccumulatorAverage.StatType[]{AccumulatorAverage.StatType.AVERAGE});
