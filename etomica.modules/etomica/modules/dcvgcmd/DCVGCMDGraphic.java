...
public class DCVGCMDGraphic extends SimulationGraphic{
	...
	//panel for Mu's
		...
		etomica.graphics.DefaultToolbar tb = new etomica.graphics.DefaultToolbar(panel(), "Dual Control-colume GCMD");
		tb.addContributor("Colin Tedlock");
	    panel().removeAll();
        panel().setLayout(new BorderLayout());
        panel().add(tb.graphic(), java.awt.BorderLayout.NORTH);
		panel().add(controlPanel, BorderLayout.WEST);
		panel().add(panel().displayPanel, BorderLayout.EAST);
