...
import etomica.overlap.DataOverlapCaching;
...
//        });
    ...
    public static class DataProcessAHT extends DataProcessor {
        ...
        protected IData processData(IData inputData) {
            if (aHistory.getHistory().willDiscardNextData()) return data;
