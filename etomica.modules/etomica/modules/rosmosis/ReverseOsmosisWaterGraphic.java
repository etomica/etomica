...
public class ReverseOsmosisWaterGraphic extends SimulationGraphic {
    ...
    public ReverseOsmosisWaterGraphic(final ReverseOsmosisWater simulation) {
    	...
    	super(simulation, TABBED_PANE, APP_NAME, REPAINT_INTERVAL, simulation.getSpace());
...
//                ((PotentialMasterList)sim.integrator.getPotential()).reset();
        ...
        MeterProfile meterProfileSodium = new MeterProfile(sim.getSpace());
        MeterProfile meterProfileChlorine = new MeterProfile(sim.getSpace());
        ...
        sim.integrator.addIntervalAction(profPumpSodium);
        sim.integrator.setActionInterval(profPumpSodium, 2);
        ...
        sim.integrator.addIntervalAction(profPumpChlorine);
        sim.integrator.setActionInterval(profPumpChlorine, 2);
