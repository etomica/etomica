...
public class MaterialFracture extends Simulation {
    ...
    public MaterialFracture() {
        ...
        box.getBoundary().setDimensions(space.makeVector(new double[]{60,30}));
        addBox(box);
        ...
        P1Tension p1 = new P1Tension(space); 
        p1.setSpringConstant(1);
        ...
        potentialMaster.addPotential(p1, new IAtomTypeLeaf[]{species.getLeafType()});
        ...
        ConfigurationLattice config = new ConfigurationLattice(new BravaisLatticeCrystal(primitive, new BasisOrthorhombicHexagonal()), space);
