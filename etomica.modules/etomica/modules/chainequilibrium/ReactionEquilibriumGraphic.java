...
//        DataTableAverages dataTable = new DataTableAverages(sim.integratorHard1, new AccumulatorAverage.Type[] { AccumulatorAverage.MOST_RECENT,
//                AccumulatorAverage.AVERAGE, AccumulatorAverage.ERROR});
		...
		// ********* Marker 
	/*	System.out.println("Graphic: New Panel for Temperature Display/Control");
		System.out.println(tPump.toString());
		System.out.println(tPump.getDataSinks());
		*/
		gbc1.gridx = 0;
		gbc1.gridy = 0;
		gbc1.gridwidth = 1;
	...
	final javax.swing.JTabbedPane sliderPanel = new javax.swing.JTabbedPane();
		...
		sliderPanel.addKeyListener(new java.awt.event.KeyListener() {
			public void keyPressed(java.awt.event.KeyEvent e) {
				// ********* Marker 
				System.out.println("Graphic: Key Pressed");
			}

			public void keyTyped(java.awt.event.KeyEvent e) {
				// ********* Marker 
				System.out.println("Graphic: Key Typed");
			...
			public void keyReleased(java.awt.event.KeyEvent e) {
				// ********* Marker 
				System.out.println("Graphic: Key Released");
			}
		});
...
javax.swing.table.DefaultTableCellRenderer numberRenderer = new javax.swing.table.DefaultTableCellRenderer() {
    ...
    public static class Applet extends javax.swing.JApplet {
		...
		public void init() {
//			 ********* Marker 
			System.out.println("Graphic: init Applete");
