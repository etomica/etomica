...
public class ColloidSim extends Simulation {
    ...
    public ColloidSim() {
        ...
        integrator = new IntegratorHard(IntegratorHard.extractHardPotentials(potentialMaster), IntegratorHard.extractFieldPotentials(pcField), neighborManager, random, 0.02, 2, box, getSpeciesManager(), null);
