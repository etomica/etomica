...
//        add(displayE2E);
    ...
    public static void main(String[] args) {
        ...
        ColloidGraphicFasterer swmdGraphic = new ColloidGraphicFasterer(new ColloidSimFasterer());
