...
public class P2HardSphereMCFasterer extends P2HardGeneric {
    ...
    public P2HardSphereMCFasterer(double sigma, double bondFac, int chainLength, AtomLeafAgentManager<? extends IAtomList> bondManager, ISpecies speciesMonomer) {
