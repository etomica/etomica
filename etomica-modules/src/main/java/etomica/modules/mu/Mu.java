...
public class Mu extends Simulation {
    ...
    public final P1MagicWall p1Wall;
    ...
    public Mu(Space _space) {
        ...
        NeighborListManagerHard neighborManager = new NeighborListManagerHard(getSpeciesManager(), box, 2, 4, BondingInfo.noBonding());
        ...
        p1Wall = new P1MagicWall(L, potentialMaster, neighborManager);
        ...
        integrator = new IntegratorHard(potentialMaster.getPairPotentials(), pcField.getFieldPotentials(), neighborManager, random, 0.01, 1, box, getSpeciesManager(), null);
