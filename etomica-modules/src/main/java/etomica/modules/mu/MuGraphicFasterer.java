...
import etomica.data.meter.MeterWidomInsertionFasterer;
...
public class MuGraphicFasterer extends SimulationGraphic {
    ...
    protected MuFasterer sim;

    public MuGraphicFasterer(final MuFasterer simulation) {
        ...
        MeterWidomInsertionFasterer meterMuA = new MeterWidomInsertionFasterer(sim.box, sim.getRandom(), sim.potentialMasterMu, sim.integrator.getTemperature());
        ...
        MeterWidomInsertionFasterer meterMuB = new MeterWidomInsertionFasterer(sim.box, sim.getRandom(), sim.potentialMasterMu, sim.integrator.getTemperature());
        ...
        DataSourceWallPressureMuFasterer meterPressure = new DataSourceWallPressureMuFasterer(space);
    ...
    public static class DataProcessorMu extends DataProcessor {
        ...
        public DataProcessorMu(AccumulatorHistory muHistory, IntegratorBoxFasterer integrator) {
    ...
    public static class ModifierLambda implements Modifier {
        public ModifierLambda(P2SquareWellOneSideFasterer p2, P2SquareWellOneSideFasterer p2Mix, P2SquareWellOneSideFasterer p2Other,
        ...
        protected final IntegratorBoxFasterer integrator;
        protected final P2SquareWellOneSideFasterer p2, p2Mix, p2Other;
        protected final P2HardGeneric p2mu, p2Mixmu, p2Othermu;
    }

    public static class ModifierEpsilon implements Modifier {
        public ModifierEpsilon(P2SquareWellOneSideFasterer p2, P2SquareWellOneSideFasterer p2Mix, P2SquareWellOneSideFasterer p2Other,
                               P2HardGeneric p2mu, P2HardGeneric p2Mixmu, P2HardGeneric p2Othermu, IntegratorBoxFasterer integrator) {
            this.integrator = integrator;
            this.p2 = p2;
            this.p2Mix = p2Mix;
            this.p2Other = p2Other;
    ...
    protected static class ModifierAtomDiameter implements Modifier {
        ...
        public ModifierAtomDiameter(MuGraphicFasterer simGraphic, SpeciesGeneral species,
                                    P2SquareWellOneSideFasterer p2, P2SquareWellOneSideFasterer p2Mix, P2SquareWellOneSideFasterer p2Other,
                                    P2HardGeneric p2mu, P2HardGeneric p2Mixmu, P2HardGeneric p2Othermu) {
        ...
        protected final MuGraphicFasterer simGraphic;
    ...
    public static void main(String[] args) {
        ...
        MuGraphicFasterer swmdGraphic = new MuGraphicFasterer(new MuFasterer(space));
