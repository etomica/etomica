...
import etomica.data.*;
import etomica.data.meter.MeterPressureHardTensorFasterer;
 ...
 */
public class DataSourceTensorVirialHardProfileFasterer extends MeterPressureHardTensorFasterer implements DataSourceIndependent {

    public DataSourceTensorVirialHardProfileFasterer(IntegratorHardFasterer integrator) {
    ...
    public void pairCollision(IAtomKinetic atom1, IAtomKinetic atom2, Vector r12, Vector dv, double virial, double tCollision) {
        ...
        super.pairCollision(atom1, atom2, r12, dv, virial, tCollision);

        Tensor virialTensor = v;
    ...
    public static class DataSourceVirialProfile implements IDataSource {
        ...
        public DataSourceVirialProfile(DataSourceTensorVirialHardProfileFasterer meter) {
            this.meter = meter;
            tag = new DataTag();
        }
        ...
        protected final DataSourceTensorVirialHardProfileFasterer meter;
