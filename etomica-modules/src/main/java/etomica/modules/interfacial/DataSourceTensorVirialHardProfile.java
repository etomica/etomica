 ...
 */
public class DataSourceTensorVirialHardProfile extends MeterPressureHardTensor implements DataSourceIndependent {

    public DataSourceTensorVirialHardProfile(IntegratorHard integrator) {
