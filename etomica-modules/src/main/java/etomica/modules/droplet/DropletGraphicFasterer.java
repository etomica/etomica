 ...
 */
public class DropletGraphicFasterer extends SimulationGraphic {

    private final static String APP_NAME = "Droplet";
    private final static int REPAINT_INTERVAL = 1;
    protected DropletFasterer sim;
    protected final DeviceNSelector nSlider;
    protected Ellipse ellipse = null;

    public DropletGraphicFasterer(final DropletFasterer simulation, Space _space) {
    ...
    public static void main(String[] args) {
        ...
        DropletFasterer sim = new DropletFasterer();
        DropletGraphicFasterer simGraphic = new DropletGraphicFasterer(sim, sp);
