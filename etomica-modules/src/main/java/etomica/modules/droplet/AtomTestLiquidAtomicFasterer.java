...
public class AtomTestLiquidAtomicFasterer implements AtomTestCollective, AtomLeafAgentManager.AgentSource<Boolean> {

    public AtomTestLiquidAtomicFasterer(NeighborListManagerFasterer neighborManager, Box box) {
    ...
    private final NeighborListManagerFasterer nbrListManager;
