 ...
 */
public class DropletFasterer extends Simulation {

    public final SpeciesGeneral species;
    public final Box box;
    public final IntegratorDropletFasterer integrator;
    ...
    public DropletFasterer() {
        ...
        integrator = new IntegratorDropletFasterer(this, pcAgg, box);
    ...
    @Override
    public IntegratorDropletFasterer getIntegrator() {
        return integrator;
    }
