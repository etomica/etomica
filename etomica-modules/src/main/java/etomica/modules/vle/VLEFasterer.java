...
import etomica.heVLE.DeviceThermoSliderGEMCFasterer;
...
public class VLEFasterer extends SimulationGraphic {
    ...
    public VLEFasterer(final VLESimFasterer sim) {
        ...
        DeviceThermoSliderGEMCFasterer thermoSlider = new DeviceThermoSliderGEMCFasterer(sim.getController(), sim.integratorLiquid, sim.integratorVapor, sim.integratorGEMC);
...
//      densityHistoryPlot.setLegend(new DataTag[]{meterDensityVapor.getTag()}, "Vapor");
        ...
        MeterPressureFasterer meterPressureLiquid = new MeterPressureFasterer(sim.boxLiquid, sim.integratorLiquid.getPotentialCompute());
        ...
        MeterPressureFasterer meterPressureVapor = new MeterPressureFasterer(sim.boxVapor, sim.integratorVapor.getPotentialCompute());
    ...
    public static void main(String[] args) {
        VLESimFasterer sim = new VLESimFasterer();
        VLEFasterer vle = new VLEFasterer(sim);
