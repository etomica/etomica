 ...
 */
public class ApiFilteredCylinderFasterer extends ApiLeafAtoms implements AtomsetIteratorBoxDependent {
    public ApiFilteredCylinderFasterer(AtomFilterInCylinder filter) {
        super();
        this.filter = filter;
    }
