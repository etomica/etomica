...
public class PistonCylinderGraphicFasterer extends SimulationGraphic {
    ...
    public DataSourceWallPressureFasterer pressureMeter;
     ...
     * this can be used.
     */
    public PistonCylinderGraphicFasterer(PistonCylinderFasterer sim) {
    ...
    public void init() {
        ...
        if (pc.getSpace().D() == 3) {
            ...
            ((DisplayBoxCanvasG3DSys) displayBox.canvas).addPlane(new PistonPlaneFasterer(space, pistonPotential));
        }
...
*/
        ...
        meterCycles = new DataSourceCountTimeFasterer(pc.integrator);
        ...
        pressureMeter = new DataSourceWallPressureFasterer(pc.integrator, 0.5 * potentialHS.getCollisionDiameter(0));
        ...
        if (doRDF) {
            ...
            double rdfCutoff = 10;
            final MeterRDFCylinderFasterer meterRDF = new MeterRDFCylinderFasterer(pc.box, pistonPotential);
        ...
        getController().getReinitButton().setPostAction(new IAction() {
            public void actionPerformed() {
                pc.integrator.setThermostat(IntegratorMDFasterer.ThermostatType.ANDERSEN);
                pc.integrator.doThermostat();
                pc.integrator.setThermostat(IntegratorMDFasterer.ThermostatType.ANDERSEN_SINGLE);
                pc.integrator.resetPiston();
                try {
                    pc.integrator.reset();
    ...
    protected class ModifierAtomDiameter implements Modifier {
        ...
        public void setValue(double d) {
            ...
            PistonCylinderFasterer sim = PistonCylinderGraphicFasterer.this.pc;
            ((DiameterHashByElementType) PistonCylinderGraphicFasterer.this.getDisplayBox(sim.box).getDiameterHash()).setDiameter(sim.species.getLeafType(), d);
            PistonCylinderGraphicFasterer.this.potentialHS.setCollisionDiameter(0, d);
            P2HardGeneric p2sqw = PistonCylinderGraphicFasterer.this.potentialSW;
    ...
    public static void main(String[] args) {
        ...
        PistonCylinderFasterer sim = new PistonCylinderFasterer(D);
        PistonCylinderGraphicFasterer pcg = new PistonCylinderGraphicFasterer(sim);
        pcg.setDoRDF(doRDF);
