 ...
 */
public class MeterRDFCylinderFasterer extends MeterRDF {

    public MeterRDFCylinderFasterer(Box box, P1HardMovingBoundary pistonPotential) {
        super(box.getSpace());
        setBox(box);
    ...
    public void reset() {
        ...
        ApiFilteredCylinderFasterer.AtomFilterInCylinder filter = new ApiFilteredCylinderFasterer.AtomFilterInCylinder(box.getBoundary(), pistonPotential, xDataSource.getXMax());
        iterator = new ApiFilteredCylinderFasterer(filter);
    }
