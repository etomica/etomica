 ...
 */
public class MCMoveSwapFasterer extends MCMoveBox {
    ...
    public MCMoveSwapFasterer(Space space, IRandom random, PotentialCompute potentialMaster, ISpecies speciesA, ISpecies speciesB) {
        super(null);
