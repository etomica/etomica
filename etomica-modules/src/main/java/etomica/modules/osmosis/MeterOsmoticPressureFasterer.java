 ...
 */
public class MeterOsmoticPressureFasterer extends DataSourceScalar implements IntegratorHardFasterer.CollisionListener {

    private double virialSum;
    private double collisionRadius;
    private final P1HardBoundary[] boundaryPotentials;
    private final IntegratorHardFasterer integrator;
    private double lastTime;

    public MeterOsmoticPressureFasterer(P1HardBoundary[] boundaryPotentials, IntegratorHardFasterer integrator) {
