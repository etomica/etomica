 ...
 *
 */
public class SelfAssemblyGraphicFasterer extends SimulationGraphic {
    ...
    protected SelfAssemblySimFasterer sim;

    public SelfAssemblyGraphicFasterer(SelfAssemblySimFasterer simulation) {
...
//                System.out.println(sim.sigAA);
    ...
    public static void main(String[] args) {
        ...
        SelfAssemblySimFasterer sim = new SelfAssemblySimFasterer(Space.getInstance(D));
        SelfAssemblyGraphicFasterer graphic = new SelfAssemblyGraphicFasterer(sim);
