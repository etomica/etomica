...
public class InsertionGraphicFasterer extends SimulationGraphic {
    ...
    public InsertionGraphicFasterer(final InsertionFasterer simulation) {
        ...
        this.getController().getReinitButton().setPostAction(new IAction() {
            public void actionPerformed() {
                ...
                sim.integrator.setThermostat(IntegratorMDFasterer.ThermostatType.ANDERSEN);
        ...
        historyMu.setTimeDataSource(new DataSourceCountTimeFasterer(sim.integrator));
    ...
    public class MeterWidom extends DataSourceScalar implements IntegratorHardFasterer.CollisionListener {
    ...
    public static void main(String[] args) {
        ...
        InsertionGraphicFasterer swmdGraphic = new InsertionGraphicFasterer(new InsertionFasterer(space));
