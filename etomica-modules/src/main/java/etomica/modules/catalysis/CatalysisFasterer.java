...
import etomica.integrator.IntegratorMDFasterer.ThermostatType;
 ...
 */
public class CatalysisFasterer extends Simulation {

    public final SpeciesGeneral speciesO, speciesC, speciesSurface;
    public final Box box;
    public final IntegratorHardFasterer integrator;

    public final P2SquareWellBondingFasterer potentialOO;
    public final P2SquareWellBondingCOFasterer potentialCO;
    public final P2HardGeneric potentialCC;
    public final P2SquareWellSurfaceFasterer potentialCS, potentialOS;
    public final ConfigurationCatalysis config;
    public final InteractionTracker interactionTracker;
    public final ReactionManagerCOFasterer reactionManagerCO;

    public CatalysisFasterer(Space space, int nCellsZ) {
        this(space, nCellsZ, new RandomMersenneTwister(RandomNumberGeneratorUnix.getRandSeedArray()));
    }

    public CatalysisFasterer(Space _space, int nCellsZ, IRandom random) {
        super(_space);
        ...
        NeighborListManagerFastererHard neighborManager = new NeighborListManagerFastererHard(getSpeciesManager(), box, 2, 9, BondingInfo.noBonding());
        ...
        reactionManagerCO = new ReactionManagerCOFasterer(this);
    ...
    public static void main(String[] args) {
        ...
        CatalysisFasterer sim = new CatalysisFasterer(space, nCellsZ);
