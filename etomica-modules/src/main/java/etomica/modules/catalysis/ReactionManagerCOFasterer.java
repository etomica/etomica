...
public class ReactionManagerCOFasterer implements IntegratorListener {

    public ReactionManagerCOFasterer(CatalysisFasterer sim) {
        this.sim = sim;
    }
    ...
    protected final CatalysisFasterer sim;
