 ...
 */
public class P2SquareWellSurface extends P2HardGeneric {
    ...
    public P2SquareWellSurface(AtomLeafAgentManager<CatalysisAgent> agentManager, double coreDiameter, double lambda, double epsilon, int minRadicalSites) {
