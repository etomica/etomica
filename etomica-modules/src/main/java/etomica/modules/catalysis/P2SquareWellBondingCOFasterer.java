 ...
 */
public class P2SquareWellBondingCOFasterer extends P2HardGeneric {
    ...
    protected P2SquareWellSurfaceFasterer potentialCS;

    public P2SquareWellBondingCOFasterer(Space space, AtomLeafAgentManager<CatalysisAgent> agentManager, double coreDiameter, double lambda, double epsilon,
    ...
    public void setCSPotential(P2SquareWellSurfaceFasterer newPotentialCS) {
