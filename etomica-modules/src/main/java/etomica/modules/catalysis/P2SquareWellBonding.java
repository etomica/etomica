 ...
 */
public class P2SquareWellBonding extends P2HardGeneric {
    ...
    public P2SquareWellBonding(AtomLeafAgentManager<CatalysisAgent> agentManager, double coreDiameter, double lambda, double epsilon,
