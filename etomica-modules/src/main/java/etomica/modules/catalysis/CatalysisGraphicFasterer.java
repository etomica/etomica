 ...
 */
public class CatalysisGraphicFasterer extends SimulationGraphic {
    ...
    protected CatalysisFasterer sim;

    public CatalysisGraphicFasterer(final CatalysisFasterer simulation, Space _space, boolean showParams) {
    ...
    public static void main(String[] args) {
        ...
        CatalysisGraphicFasterer swmdGraphic = new CatalysisGraphicFasterer(new CatalysisFasterer(space, nCellsZ), space, showParams);
