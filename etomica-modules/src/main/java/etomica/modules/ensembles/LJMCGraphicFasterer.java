...
public class LJMCGraphicFasterer extends SimulationGraphic {
    ...
    public LJMCGraphicFasterer(final LJMCFasterer simulation) {
    ...
    public static void main(String[] args) {
        ...
        LJMCGraphicFasterer ljmdGraphic = new LJMCGraphicFasterer(new LJMCFasterer(sp));
