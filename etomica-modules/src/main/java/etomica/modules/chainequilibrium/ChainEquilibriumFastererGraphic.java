 ...
 */
public class ChainEquilibriumFastererGraphic extends SimulationGraphic {

    private static final String APP_NAME = "Stepwise Growth Polymerization";
    private static final int REPAINT_INTERVAL = 2;

    protected ChainEquilibriumFastererSim sim;

    public ChainEquilibriumFastererGraphic(ChainEquilibriumFastererSim simulation) {
...
//        epsilonSliders.add(ACSlider.graphic(null), vertGBC);
    ...
    public static void main(String[] args) {
        ...
        ChainEquilibriumFastererSim sim = new ChainEquilibriumFastererSim(Space.getInstance(D));
        ChainEquilibriumFastererGraphic graphic = new ChainEquilibriumFastererGraphic(sim);
