 ...
 */
public class SamGraphicFasterer extends SimulationGraphic {
    ...
    public SamGraphicFasterer(final SamFasterer sim) {
        ...
        sim.integrator.getEventManager().addListener(pumpListener);
        pumpListener.setInterval(10);
        MeterEnergyFromIntegratorFasterer meterEnergy = new MeterEnergyFromIntegratorFasterer(sim.integrator);
        ...
        MeterWallPressureFasterer wallPressure = new MeterWallPressureFasterer(sim);
    ...
    public static void main(String[] args) {
        ...
        SamGraphicFasterer graphic = new SamGraphicFasterer(sim);
        graphic.makeAndDisplayFrame();
    }

    public static class DataPipeStressStrain extends DataProcessor {
        protected final SamFasterer sim;
        protected DataDoubleArray data;
        protected DataInfoDoubleArray dataInfo;

        public DataPipeStressStrain(SamFasterer sim) {
            super();
            this.sim = sim;
        }
    ...
    public class ActionMoveWall implements IAction {
        ...
        private final SamFasterer sim;
        private final IAction moveWallToggle;
        public boolean enabled;

        protected ActionMoveWall(DeviceSlider wallPositionSlider, SamFasterer sim,
    ...
    public static class ModifierWallPosition implements Modifier {
        ...
        public ModifierWallPosition(SamFasterer sim) {
            this.sim = sim;
            update();
        }
