...
public class Sam extends Simulation {
    ...
    public NeighborListManager neighborManagerGeneral;
    ...
    public Sam() {
        ...
        sigmaCH2 = 3.95;
        potentialMaster = new PotentialMasterList(getSpeciesManager(), box, 2, 2.8 * sigmaCH2, potentialMasterBonding.getBondingInfo()); //List(this, 2.0);
...
//        updateConformation(0);
        ...
        neighborManagerGeneral = new NeighborListManager(getSpeciesManager(), box, 2, nbrCut, potentialMasterBonding.getBondingInfo());
        ...
        integrator = new IntegratorVelocityVerlet(pcAggregate, random, 0.002, Kelvin.UNIT.toSim(300), box);
