...
public class SwmdGraphicFasterer extends SimulationGraphic {
    ...
    public SwmdGraphicFasterer(final SwmdFasterer simulation) {
...
//        tempSlider.setPrecision(1);
        ...
        this.getController().getReinitButton().setPostAction(new IAction() {
            public void actionPerformed() {
                ...
                sim.integrator.setThermostat(IntegratorMDFasterer.ThermostatType.ANDERSEN_SINGLE);
    ...
    public static void main(String[] args) {
        ...
        SwmdGraphicFasterer swmdGraphic = new SwmdGraphicFasterer(new SwmdFasterer(space));
