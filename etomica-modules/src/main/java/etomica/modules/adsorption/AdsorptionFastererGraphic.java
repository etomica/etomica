 ...
 */
public class AdsorptionFastererGraphic extends SimulationGraphic {
    ...
    protected final AdsorptionFasterer sim;

    public AdsorptionFastererGraphic(final AdsorptionFasterer simulation, Space _space) {
        ...
        final DataSourceCountTimeFasterer timer = new DataSourceCountTimeFasterer(sim.integratorMD);
        ...
        final ModifierPMuFasterer pmu = new ModifierPMuFasterer(sim.p2AA, sim.integratorMC, eos, sim.mcMoveIDA, meterCountAtoms);
        pmu.setValue(-4);
        ...
        final ModifierPMuFasterer pmuB = new ModifierPMuFasterer(sim.p2BB, sim.integratorMC, eosB, sim.mcMoveIDB, meterCountAtomsB);
        pmuB.setValue(-4);
        ...
        MeterPotentialEnergyFromIntegratorFasterer meterPE = new MeterPotentialEnergyFromIntegratorFasterer(sim.integratorMD);
...
//        add(temperatureHistoryPlot);
    ...
    public static void main(String[] args) {
        ...
        AdsorptionFastererGraphic adsGraphic = new AdsorptionFastererGraphic(new AdsorptionFasterer(), space);
