...
public class ModifierPMuFasterer implements Modifier {

    protected final EOSSW eos;
    protected final MyMCMoveFasterer move;
    ...
    public ModifierPMuFasterer(P2HardGeneric p2, IntegratorBoxFasterer integrator, EOSSW eos, MyMCMoveFasterer move, MeterExcessAdsorbed meterCountAtoms) {
        this.p2 = p2;
