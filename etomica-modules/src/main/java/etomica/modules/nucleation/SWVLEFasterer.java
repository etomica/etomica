...
import etomica.graphics.DeviceThermoSliderGEMCFasterer;
...
public class SWVLEFasterer extends SimulationGraphic {
    ...
    public SWVLEFasterer(final SWVLESimFasterer sim) {
    ...
    public static void main(String[] args) {
        ...
        SWVLESimFasterer sim = new SWVLESimFasterer(D);
        SWVLEFasterer SWVLE = new SWVLEFasterer(sim);
