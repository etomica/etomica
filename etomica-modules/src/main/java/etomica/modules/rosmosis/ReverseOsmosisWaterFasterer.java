 ...
 */
public class ReverseOsmosisWaterFasterer extends Simulation implements MeterOsmoticPressureFasterer.WallForceSource {
    ...
    public ReverseOsmosisWaterFasterer() {
        ...
        PotentialMasterFasterer potentialMaster = new PotentialMasterFasterer(getSpeciesManager(), box, BondingInfo.noBonding()); //List(this, 2.0);
    ...
    public static void main(String[] args) {
        ReverseOsmosisWaterFasterer sim = new ReverseOsmosisWaterFasterer();
