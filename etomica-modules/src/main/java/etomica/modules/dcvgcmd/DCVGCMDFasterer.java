...
public class DCVGCMDFasterer extends Simulation {
    ...
    public P1WCAPorousWallFasterer potentialwallPorous;
    ...
    private DCVGCMDFasterer(Space _space) {
        ...
        PotentialMasterListFasterer potentialMasterList = new PotentialMasterListFasterer(getSpeciesManager(), box, 1, potential.getRange() * neighborRangeFac, BondingInfo.noBonding());
        ...
        potentialwallPorous = new P1WCAPorousWallFasterer(box, sigma, epsilon, poreRadius, z);
        ...
        meterFlux0 = new MeterFluxFasterer(moves[0], integratorMD);
        meterFlux1 = new MeterFluxFasterer(moves[1], integratorMD);
        meterFlux2 = new MeterFluxFasterer(moves[2], integratorMD);
        meterFlux3 = new MeterFluxFasterer(moves[3], integratorMD);
