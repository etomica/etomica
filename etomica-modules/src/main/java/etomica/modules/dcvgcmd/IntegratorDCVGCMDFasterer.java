...
public class IntegratorDCVGCMDFasterer extends IntegratorBoxFasterer {
	...
	public IntegratorDCVGCMDFasterer(PotentialCompute compute, double temperature,
	...
	public void setIntegrators(IntegratorMCFasterer intmc, IntegratorMDFasterer intmd, IRandom random) {
		integratormc = intmc;
		integratormd = intmd;
		integratormc.setTemperature(temperature);
		integratormd.setTemperature(temperature);
		mcMove1 = new MyMCMoveFasterer(this, random, space, -zFraction);
		mcMove2 = new MyMCMoveFasterer(this, random, space, +zFraction);
		...
		mcMove3 = new MyMCMoveFasterer(this, random, space, -zFraction);
		mcMove4 = new MyMCMoveFasterer(this, random, space, +zFraction);
