...
public class MeterFlux extends DataSourceScalar implements IDataSource {

    public MeterFlux(MyMCMove move, IntegratorMD integrator) {
    ...
    private IntegratorMD integratorMD;
}
