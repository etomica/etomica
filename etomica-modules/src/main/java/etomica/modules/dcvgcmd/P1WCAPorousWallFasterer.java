 ...
 */
public class P1WCAPorousWallFasterer implements IPotentialField {
    ...
    public P1WCAPorousWallFasterer(Box box, double sigma, double epsilon, double poreRadius, double z) {
