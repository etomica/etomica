...
public class LjmdGraphicFasterer extends SimulationGraphic {
    ...
    protected LjmdFasterer sim;

    private final boolean showConfig = false;

    public LjmdGraphicFasterer(final LjmdFasterer simulation) {
...
//                tBox.putData(temperatureHistory.getData());
    ...
    public static void main(String[] args) {
        ...
        LjmdGraphicFasterer ljmdGraphic = new LjmdGraphicFasterer(new LjmdFasterer(sp));
