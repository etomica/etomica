...
public class LjmdGraphic1D extends SimulationGraphic {
    ...
    protected Ljmd1D sim;

    private boolean showConfig = false;

    public LjmdGraphic1D(final Ljmd1D simulation, Space _space) {
...
//        sim.integrator.addListener(new IntervalActionAdapter(this.getDisplayBoxPaintAction(sim.box)));
        ...
        nSlider.setPostAction(new IAction() {
            ...
            ConfigurationLattice config = new ConfigurationLattice(new LatticeCubicSimple(space), space);
...
//                tBox.putData(temperatureHistory.getData());
    ...
    public static void main(String[] args) {
        ...
        LjmdGraphic1D ljmdGraphic = new LjmdGraphic1D(new Ljmd1D(sp), sp);
