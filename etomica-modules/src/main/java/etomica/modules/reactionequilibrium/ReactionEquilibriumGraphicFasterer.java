...
public class ReactionEquilibriumGraphicFasterer extends SimulationGraphic {
	...
	public ReactionEquilibriumGraphicFasterer(ReactionEquilibriumFasterer simulation, Space space) {
...
// FROM THIS IMPLEMENTATION OF AVERAGE DISPLAY.
		...
		DataSourceCountTimeFasterer timeCounter = new DataSourceCountTimeFasterer(sim.integratorHard1);
...
//        filter3.setDataSink(new DataSinkConsole());
	...
	public static void main(String[] args) {
		...
		ReactionEquilibriumFasterer sim = new ReactionEquilibriumFasterer();
		ReactionEquilibriumGraphicFasterer graphic = new ReactionEquilibriumGraphicFasterer(sim, sim.getSpace());
	...
	class DiameterModifier implements Modifier {
		P2SquareWellBondedFasterer potentialRR, potentialRB, potentialBB;

		SpeciesGeneral speciesR, speciesB;

		DisplayBox display;

		DiameterModifier(P2SquareWellBondedFasterer potentialRR,
						 P2SquareWellBondedFasterer potentialRB, P2SquareWellBondedFasterer potentialBB,
