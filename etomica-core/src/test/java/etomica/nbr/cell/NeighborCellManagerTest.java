...
class NeighborCellManagerTest {
    ...
    void testRectangular() {
        ...
        for (int n = 1; n <= 4; n++) {
            NeighborCellManager ncmRectangular = new NeighborCellManager(sim.getSpeciesManager(), boxRectangular, n, BondingInfo.noBonding());
    ...
    void testDeformable() {
        ...
        for (int n = 1; n <= 4; n++) {
            NeighborCellManager ncmSlanty = new NeighborCellManager(sim.getSpeciesManager(), boxSlanty, n, BondingInfo.noBonding());
