 ...
 */
public class ColorSchemeOverlapFasterer extends ColorSchemeCollectiveAgent {

    public ColorSchemeOverlapFasterer(Space space, NeighborManager neighborManager, Box box) {
        super(box);
