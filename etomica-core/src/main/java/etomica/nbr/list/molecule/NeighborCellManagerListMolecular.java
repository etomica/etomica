...
import etomica.nbr.cell.molecule.CellMolecular;
...
public class NeighborCellManagerListMolecular extends NeighborCellManagerMolecular {
    ...
    public NeighborCellManagerListMolecular(SpeciesManager sm, Box box,
    ...
    public NeighborCellManagerListMolecular(SpeciesManager sm, Box box,
                                            ...
                                            Space _space) {
        super(sm, box, potentialRange, positionDefinition, _space);
    }
    ...
    public CellMolecular makeAgent(IMolecule molecule) {
        ...
        CellMolecular cell = super.makeAgent(molecule);
