...
public class NeighborCellManager1 implements NeighborManager {
    ...
    public NeighborCellManager1(SpeciesManager sm, Box box, int cellRange, BondingInfo bondingInfo) {
        this (sm,box,cellRange,bondingInfo,false);
    }
    public NeighborCellManager1(SpeciesManager sm, Box box, int cellRange, BondingInfo bondingInfo, boolean handleOutOfBox) {
        this.box = box;
        this.cellRange = cellRange;
        this.rectangular = box.getBoundary().isRectangular();
        this.handleOutOfBox = handleOutOfBox;
    ...
    public NeighborIterator makeNeighborIterator() {
       // return new NeighborIteratorCell(this, bondingInfo, isPureAtoms, box);
        return new NeighborIteratorCellFaster1(this,box);
    }
...
//            System.out.println();
    ...
    public boolean isHandleOutOfBox() {
        return handleOutOfBox;
    }
}
