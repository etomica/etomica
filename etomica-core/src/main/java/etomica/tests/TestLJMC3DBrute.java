...
public class TestLJMC3DBrute extends Simulation {
    ...
    public TestLJMC3DBrute(int numAtoms, Configuration config) {
        ...
        double sigma = 1.0;
        box = this.makeBox();
        potentialMaster = new PotentialMaster(this.getSpeciesManager(), box, BondingInfo.noBonding());
    ...
    public static void main(String[] args) {
        ...
        TestLJMC3DBrute sim = new TestLJMC3DBrute(numAtoms, config);
