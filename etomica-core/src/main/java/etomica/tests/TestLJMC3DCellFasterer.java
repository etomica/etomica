 ...
 */
public class TestLJMC3DCellFasterer extends Simulation {
    ...
    public TestLJMC3DCellFasterer(int numAtoms, int numSteps, Configuration config) {
        ...
        double sigma = 1.0;
        box = this.makeBox();
        PotentialMasterCellFasterer potentialMaster = new PotentialMasterCellFasterer(this, box, 2);
    ...
    public static void main(String[] args) {
        ...
        Configuration config = Configurations.fromResourceFile(String.format("LJMC3D%d.pos", numAtoms), TestLJMC3DCellFasterer.class);

        TestLJMC3DCellFasterer sim = new TestLJMC3DCellFasterer(numAtoms, params.numSteps, config);
