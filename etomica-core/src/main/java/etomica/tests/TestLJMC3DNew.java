...
public class TestLJMC3DNew extends Simulation {
    ...
    public TestLJMC3DNew(int numAtoms, Configuration config) {
    ...
    public static void main(String[] args) {
        ...
        Configuration config = Configurations.fromResourceFile(String.format("LJMC3D%d.pos", numAtoms), TestLJMC3DNew.class);

        TestLJMC3DNew sim = new TestLJMC3DNew(numAtoms, config);
