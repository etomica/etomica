 ...
 */
public class MoleculeListProperty implements Property {

    private final Object instance;
    private final String name;
    private final Method reader;

    public MoleculeListProperty(Object instance, PropertyDescriptor descriptor) {
