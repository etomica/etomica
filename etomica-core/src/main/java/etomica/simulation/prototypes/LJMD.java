...
public class LJMD extends Simulation {
    ...
    public LJMD(Space space, double density, int numAtoms, boolean useNbrLists, boolean doNHC) {
        super(space);
        ...
        double rc = 3;
        PotentialMaster potentialMaster = useNbrLists ? new PotentialMasterList(getSpeciesManager(), box, 2, rc + 1, BondingInfo.noBonding())
                : new PotentialMaster(getSpeciesManager(), box, BondingInfo.noBonding());
        ...
        double sigma = 1.0;
        IPotential2 potential = P2LennardJones.makeTruncated(sigma, 1.0, new TruncationFactoryForceShift(rc));
    ...
    public static void main(String[] args) {
        ...
        final LJMD sim = new LJMD(Space3D.getInstance(), 0.8, 864, true, true);
