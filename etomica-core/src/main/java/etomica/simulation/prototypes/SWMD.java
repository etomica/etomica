...
public class SWMD extends Simulation {
    ...
    public SWMD(Space space) {
        ...
        box = this.makeBox();
        NeighborListManagerHard neighborManager = new NeighborListManagerHard(getSpeciesManager(), box, 2, 2.5, BondingInfo.noBonding());
    ...
    public static void main(String[] args) {
        ...
        final SWMD sim = new SWMD(Space3D.getInstance());
