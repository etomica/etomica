...
public class PotentialCalculationPhiSumHeisenberg implements PotentialCalculationMolecular {
	 ...
	 //TODO Still use dipole source or use get positions? or just use get position???
	...
	public void doCalculation(IAtomList atoms, IPotentialAtomic potential) {
		//maybe you need to come back in the future, leave it blank for now
	...
	public void doCalculation(IMoleculeList molecules, IPotentialMolecular potential) {
		...
		secondDerivativeSum = t[0].component(0, 0)*phiC+t[0].component(0, 1)*phiC
						 	+ t[0].component(1, 0)*phiC+t[0].component(1, 1)*phiC;//TODO sum first then *phiC
							//TODO only IJ phi is this right component???
	}
