 ...
 */
public class P2ElectrostaticWithHardCore implements IPotential2 {

    public static IPotential2 makeTruncated(TruncationFactory tf, double charge1, double charge2) {
