 ...
 * the regular Voronoi tessellation. */
public class RadiusMono implements Radius {
    ...
    @Override
    public boolean r_ctest(double crs, double mrs) {return crs>mrs;}
    /** Scales a plane displacement during a plane bounds check.
     * \param[in] lrs the plane displacement.
     * \return The scaled value. */
    @Override
    public double r_cutoff(double lrs) {return lrs;}
    ...
    @Override
    public double r_max_add(double rs) {return rs;}
    ...
    @Override
    public double r_current_sub(double rs, int ijk, int q) {return rs;}
    ...
    @Override
    public double r_scale(double rs, int ijk, int q) {return rs;}
     ...
     * otherwise. */
    public boolean r_scale_check(double[] rs, double mrs, int ijk, int q) {return rs[0]<mrs;}
