...
public class HistogramVectorEnergy {
    ...
    public HistogramVectorEnergy(int nX, int nY, int nZ, DoubleRange rangeX, DoubleRange rangeY, DoubleRange rangeZ, ISpecies species, Box box, long numsteps){
        nBinsX = nX;
        nBinsY = nY;
        nBinsZ = nZ;
