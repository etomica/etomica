...
public class MeterPressureTensorFasterer implements IDataSourcePotential {
     ...
     */
    public MeterPressureTensorFasterer(PotentialCompute potentialMaster, Box box) {
        this(potentialMaster, box, Double.NaN);
        doNonEquilibrium = true;
    }

    public MeterPressureTensorFasterer(PotentialCompute potentialMaster, Box box, double temperature) {
