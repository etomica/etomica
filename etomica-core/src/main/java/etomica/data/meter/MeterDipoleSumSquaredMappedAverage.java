...
import etomica.potential.PotentialCallbackPhiSum;
 ...
 * @author Weisong
 */
public class MeterDipoleSumSquaredMappedAverage implements IDataSource {

    protected final DataDoubleArray data;
    protected final DataInfoDoubleArray dataInfo;
    protected final DataTag tag;
    protected final PotentialCallbackPhiSum secondDerivativeSum;
    ...
    public MeterDipoleSumSquaredMappedAverage(Box box, double dipoleMagnitude, double temperature,
...
//        r = space.makeVector();
        vectorSum.setX(2, 1);
        secondDerivativeSum = new PotentialCallbackPhiSum(box, dipoleSource);
        dr = space.makeVector();
