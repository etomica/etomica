...
public class MeterPotentialEnergysquare extends DataSourceScalar {

    public MeterPotentialEnergysquare(PotentialMaster potentialMaster) {
    ...
    public MeterPotentialEnergysquare(PotentialMaster potentialMaster, Box box) {
    ...
    */
    public double getDataAsScalar() {
        ...
        return (energy.getSum()*energy.getSum());
    }
    /**
