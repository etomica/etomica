...
public class MeterPotentialEnergyFasterer extends DataSourceScalar implements IDataSourcePotential {

    protected Box box;
    protected final PotentialCompute potentialMaster;
    protected boolean callComputeAll;

    public MeterPotentialEnergyFasterer(PotentialCompute potentialMaster) {
