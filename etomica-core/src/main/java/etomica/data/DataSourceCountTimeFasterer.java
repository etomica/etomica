 ...
 */
public class DataSourceCountTimeFasterer extends DataSourceScalar {

	public DataSourceCountTimeFasterer(IntegratorMDFasterer integrator) {
	...
	protected IntegratorMDFasterer integrator;
}
