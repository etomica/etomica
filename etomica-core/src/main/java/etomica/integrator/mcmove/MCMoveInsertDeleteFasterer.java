 ...
 * @author David Kofke
 */
public class MCMoveInsertDeleteFasterer extends MCMoveBox {
     ...
     */
    public MCMoveInsertDeleteFasterer(PotentialCompute potentialMaster, IRandom random, Space space) {
        super(null);
