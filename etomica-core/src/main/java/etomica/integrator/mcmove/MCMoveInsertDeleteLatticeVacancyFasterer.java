 ...
 */
public class MCMoveInsertDeleteLatticeVacancyFasterer extends MCMoveInsertDeleteBiasedFasterer implements IListener<MCMoveEvent> {
    ...
    public MCMoveInsertDeleteLatticeVacancyFasterer(PotentialCompute potentialMaster, NeighborManager neighborManager,
