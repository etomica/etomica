 ...
 */
public class MCMoveInsertDeleteBiasedFasterer extends MCMoveInsertDeleteFasterer {

    protected int minN, maxN;
    protected double[] lnbias;

    public MCMoveInsertDeleteBiasedFasterer(PotentialCompute potentialMaster,
