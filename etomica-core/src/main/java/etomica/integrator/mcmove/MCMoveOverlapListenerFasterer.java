...
public class MCMoveOverlapListenerFasterer implements IListener<MCMoveEvent> {

    protected final MCMoveInsertDeleteBiasedFasterer mcMove;
    ...
    public MCMoveOverlapListenerFasterer(MCMoveInsertDeleteBiasedFasterer mcMove, int numAlpha, double daDef, int numAtomsLattice, double daSpan) {
        this.mcMove = mcMove;
