 ...
 */
public class MCMoveIDBiasActionFasterer implements IAction {
    ...
    public MCMoveIDBiasActionFasterer(IntegratorMCFasterer integratorMC, MCMoveInsertDeleteBiasedFasterer mcMoveID, int maxVacancy, double bmu,
                                      MCMoveOverlapListenerFasterer mcMoveOverlapMeter, int numAtoms) {
