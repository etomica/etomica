...
public class MCMoveMoleculeExchangeVLEFasterer extends MCMoveMoleculeExchangeFasterer {
    private final MeterDensity meterDensity1;
    private final MeterDensity meterDensity2;

    public MCMoveMoleculeExchangeVLEFasterer(IRandom random, Space space,
