...
//                    System.out.println("d2 "+r2d2udr2/rij2+" "+ijTensor.component(0,0)+" "+tt1Tensor.component(0,0));
    ...
    public static void main1(String[] args) {
        ...
        SpeciesGeneral species = SpeciesSpheresRotating.create(space, new ElementSimple("CO2", Carbon.INSTANCE.getMass()+2*Oxygen.INSTANCE.getMass()));
...
//        atom1.getOrientation().setDirection(space.makeVector(new double[]{1/Math.sqrt(2),0.5,0.5}));
        ...
        Vector y = Vector.of(new double[]{0.0, 1.0, 0.0});
        Vector z = Vector.of(new double[]{0.0, 0.0, 1.0});
        double lg = 0;
        double lu = 0;
...
//        }
    ...
    public static void main(String[] args) {
        ...
        double temperature = Kelvin.UNIT.toSim(200);
        Simulation sim = new Simulation(space);
        SpeciesGeneral speciesCO2 = SpeciesSpheresRotating.create(space, new ElementSimple("CO2", Carbon.INSTANCE.getMass()+2*Oxygen.INSTANCE.getMass()));
...
//        ((IAtomOriented)pair.getAtom(0)).getOrientation().setDirection(space.makeVector(new double[]{Math.cos(22.5/180.0*Math.PI), Math.sin(22.5/180.0*Math.PI),0}));
        ...
        double dx = 0.0001;
        Vector x = null;
        Vector y = Vector.of(new double[]{0, 1, 0});
