...
public class DLJFasterer extends Simulation {
    ...
    protected final MCMoveAtomFasterer moveMolecule;//translation
    protected final MCMoveAtomRotateFasterer rotateMolecule;//rotation, atomic
    protected final Box box;
    protected SpeciesGeneral species;

    //************************************* constructor ********************************************//
    public DLJFasterer(Space space, int numberMolecules, final double sigmaLJ, double epsilonLJ, double mu,
        ...
        Potential2Soft pLJ = P2LennardJones.makeTruncated(space, sigmaLJ, epsilonLJ, new TruncationFactorySimple(space, truncation));
        // add reaction field potential
        DipoleSourceDLJ dipoleSourceDLJ = new DipoleSourceDLJ(space, mu);// add reaction field potential
        P2ReactionFieldDipoleFasterer pRF = new P2ReactionFieldDipoleFasterer(space, dipoleSourceDLJ);
        ...
        // add mc move
        moveMolecule = new MCMoveAtomFasterer(random, potentialMaster, box);//stepSize:1.0, stepSizeMax:15.0  ??????????????
...
//        System.out.println("dipoleStrength="+dipoleStrength);
        ...
        final DLJFasterer sim = new DLJFasterer(space,numberMolecules,sigmaLJ, epsilonLJ, dipoleStrength,
