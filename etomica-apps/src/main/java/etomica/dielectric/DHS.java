...
public class DHS extends Simulation {
	...
	protected final MCMoveAtom moveMolecule;//translation mc move
	protected final MCMoveAtomRotate rotateMolecule;//atomic rotation mc move
	protected final Box box;

	//************************************* constructor ********************************************//
    public DHS(Space space, int numberMolecules, final double HSDiameter, double mu,
...
//		System.out.println("in main class, magnitude of dipole:"+dipoleDHS.dipoleStrength);
        P2ReactionFieldDipole pRF = new P2ReactionFieldDipole(space, dipoleDHS);
        ...
        moveMolecule = new MCMoveAtom(random, potentialMaster, box);
...
//		System.out.println("HSDiameter= "+HSDiameter);
		...
		final DHS sim = new DHS(space,numberMolecules,HSDiameter,dipoleStrength,dielectricOutside,boxSize,temperature,truncation);
...
//		System.out.println("sample per block is : " + samplePerBlock);
		...
		MeterDipoleSumSquaredMappedAverage AEEMeter = new MeterDipoleSumSquaredMappedAverage(sim.box, dipoleStrength, temperature, sim.potentialMaster,
