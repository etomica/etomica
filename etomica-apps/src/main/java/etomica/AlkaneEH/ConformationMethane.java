...
public class ConformationMethane implements IConformation {
   ...
   // 	double angleEq =  109.5 * Math.PI/180;
    	...
    	if (false){    	  
	        ...
	        IVectorMutable vector_ch1 = space.makeVector();
	        ...
	        IVectorMutable vector_ch2 = space.makeVector();
	        ...
	        IVectorMutable vector_ch3 = space.makeVector();
	        ...
	        IVectorMutable vector_ch4 = space.makeVector();
	        ...
	        IVectorMutable ch14 = space.makeVector();
	        ch14.E(vector_ch1);
	        ...
	        IVectorMutable ch24 = space.makeVector();
	        ch24.E(vector_ch2);
	        ...
	        IVectorMutable ch34 = space.makeVector();
	        ch34.E(vector_ch3);
