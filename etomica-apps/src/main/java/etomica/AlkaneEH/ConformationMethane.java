...
public class ConformationMethane implements IConformation {
   ...
   // 	double angleEq =  109.5 * Math.PI/180;
    	...
    	if (false){    	  
	        ...
	        IVector vector_ch1 = space.makeVector();
	        ...
	        IVector vector_ch2 = space.makeVector();
	        ...
	        IVector vector_ch3 = space.makeVector();
	        ...
	        IVector vector_ch4 = space.makeVector();
