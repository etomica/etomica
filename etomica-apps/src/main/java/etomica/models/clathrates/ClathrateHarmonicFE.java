...
public class ClathrateHarmonicFE extends Simulation {
    ...
    public ClathrateHarmonicFE(Space space, int[] nC, double rCutRealES, double[] a0_sc, int numMolecule, String configFileName, boolean isIce, double kCut, boolean includeM) {
        super(space);
...
//            sigma = 3.154; epsilon = Kelvin.UNIT.toSim(78.0); //TIP4P
        ...
        PotentialMasterCell pm = new PotentialMasterCell(getSpeciesManager(), box, 3, BondingInfo.noBonding());
    ...
    public static void main(String[] args) {
        ...
        final ClathrateHarmonicFE sim = new ClathrateHarmonicFE(space, nC, rCutRealES, a0_sc, numMolecule, configFile, isIce, kCut, includeM);
