...
public class Clathrateenergyandcvworks extends Simulation {
    ...
    public Clathrateenergyandcvworks(Space space, double temperature, int numCells, double rCutRealES, double rCutLJ, boolean isIce, double kCut, double shakeTol, boolean unitCells, final boolean doTranslation, final boolean doRotation, double timeInterval) {
...
//////////minimized file
        ...
        latticeCoordinates = new MoleculeAgentManager(this, box, new MoleculeSiteSource(space, new MoleculePositionCOM(space), new Clathrateenergyandcvworks.WaterOrientationDefinition(space)));
...
//        System.out.println("o at "+((IAtomPositioned)box.getLeafList().getAtom(2)).getPosition());
    ...
    public static void main(String[] args) {
        ...
        final Clathrateenergyandcvworks sim = new Clathrateenergyandcvworks(Space3D.getInstance(), temperature, numCells, rCutRealES, rCutLJ, isIce, kCut, shakeTol, uniteCells, doTranslation, doRotation, timeInterval);
