 ...
 * cutoffs.
 */
public class MeterPUCutFasterer implements IDataSource {
    ...
    public MeterPUCutFasterer(Box box, PotentialCompute potentialMaster, double temperature, double[] cutoffs) {
        this(box, potentialMaster, null, temperature, cutoffs);
    }

    public MeterPUCutFasterer(Box box, PotentialCompute potentialMaster, PotentialCompute potentialMasterDADv2, double temperature, double[] cutoffs) {
