...
public class MeterPotentialEnergyCutoffFasterer implements IDataSource {

    public MeterPotentialEnergyCutoffFasterer(PotentialCompute potentialMaster, Space space, double[] cutoffs) {
