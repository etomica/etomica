...
public class MeterMappedRdfnewest implements IEtomicaDataSource, DataSourceIndependent, Serializable, AtomLeafAgentManager.AgentSource<IntegratorVelocityVerlet.MyAgent> {
    ...
    public MeterMappedRdfnewest(double rcforHandfinmap, Space space, PotentialMaster potentialMaster, Box box, int nbins, double density) {
        this.space = space;
        this.box = box;
this.density=density;
    ...
    public IData getData() {
        ...
        double[] newestgterm = pc.getnewestGSum();
        double[] gR = pc.gR();
