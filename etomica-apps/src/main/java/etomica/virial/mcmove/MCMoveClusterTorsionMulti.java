 ...
 */
public class MCMoveClusterTorsionMulti extends MCMoveBox {
    ...
    public MCMoveClusterTorsionMulti(PotentialCompute pc, Space space, IRandom random,
                                     P4BondTorsion torsionPotential) {
        this(pc, space, random, torsionPotential, 20);
        setBondLength(1.0);
    }

    public MCMoveClusterTorsionMulti(PotentialCompute pc, Space space,
...
//                        System.out.println("error: "+(Math.acos(newcosphi)-Math.acos(newcosphicheck)));
            ...
            oldCenter.ME(positionDefinition.position(selectedMolecules.get(i)));
            for (int k=0; k<numChildren; k++) {
