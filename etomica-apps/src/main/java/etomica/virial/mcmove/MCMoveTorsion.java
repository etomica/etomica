...
public class MCMoveTorsion extends MCMoveBoxStep {
    ...
    public MCMoveTorsion(PotentialCompute potentialCompute, Space space, IntArrayList[] bonding, IRandom random, double stepSize) {
        super(null);
