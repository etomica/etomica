 ...
 */
public class MCMoveClusterAngleBendFasterer extends MCMoveBoxStep {
    ...
    public MCMoveClusterAngleBendFasterer(IRandom random, PotentialCompute pc, Space _space) {
