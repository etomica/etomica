...
public class ClusterSumPolarizableWertheimProduct4Pt implements ClusterAbstract, java.io.Serializable {
...
//        checkF(cPairs,aPairs);
        ...
        calcValue();//only additive interaction
        boolean tooClose = pushR2 > 0;//pushR2: minimum distance
        for(int i=0; i<nPoints-1; i++) {
            for(int j=i+1; j<nPoints; j++) {
                ...
                if (r2 > deltaCut2) {
                	value = 0.0;
                    return value;//only additive interaction
                }
            ...
            if (g12*g13*g14*g23*g24*g34 != 0)
        		{
	                ...
	                value *= (expBetaU1234-expBetaU123/g14/g34/g24*(1+g14-1+g34-1+g24-1)-expBetaU124/g13/g23/g34*(1+g13-1+g23-1+g34-1)-expBetaU134/g12/g23/g24*(1+g12-1+g23-1+g24-1)-expBetaU234/g12/g13/g14*(1+g12-1+g13-1+g14-1));
	                if (debug){
	                	System.out.println("expBetaU1234 "+expBetaU1234);
	                	System.out.println("3pt*f123 "+expBetaU123*(1+g14-1+g34-1+g24-1));
	                	System.out.println("3pt*f124 "+expBetaU124*(1+g13-1+g23-1+g34-1));
	                	System.out.println("3pt*f134 "+expBetaU134*(1+g12-1+g23-1+g24-1));
	                	System.out.println("3pt*f234 "+expBetaU234*(1+g12-1+g13-1+g14-1));
