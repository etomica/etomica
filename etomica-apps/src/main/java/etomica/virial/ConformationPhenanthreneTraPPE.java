...
public class ConformationPhenanthreneTraPPE implements IConformation, java.io.Serializable{
	...
	public void initializePositions(IAtomList atomList) {
		...
		IAtom n1 = atomList.getAtom(SpeciesTraPPEPhenanthrene.indexC1);
		n1.getPosition().E(new double[] {0, a, 0});
		
		IAtom n2 = atomList.getAtom(SpeciesTraPPEPhenanthrene.indexC2);
		n2.getPosition().E(new double[] {0, -a, 0});
						
		IAtom n3 = atomList.getAtom(SpeciesTraPPEPhenanthrene.indexC3);
		n3.getPosition().E(new double[] {sqrt3a, -bond, 0});
				
		IAtom n4 = atomList.getAtom(SpeciesTraPPEPhenanthrene.indexC4);
		n4.getPosition().E(new double[] {twosqrt3a, -a, 0});
		
		
		// put the other CH United atoms
		IAtom n5 = atomList.getAtom(SpeciesTraPPEPhenanthrene.indexCH1);
		n5.getPosition().E(new double[] {-sqrt3a, bond, 0});
		
		IAtom n6 = atomList.getAtom(SpeciesTraPPEPhenanthrene.indexCH2);
		n6.getPosition().E(new double[] {-twosqrt3a, a, 0});
		
		IAtom n7 = atomList.getAtom(SpeciesTraPPEPhenanthrene.indexCH3);
		n7.getPosition().E(new double[] {-twosqrt3a, -a, 0});
		
		IAtom n8 = atomList.getAtom(SpeciesTraPPEPhenanthrene.indexCH4);
		n8.getPosition().E(new double[] {-sqrt3a, -bond, 0});
		
		IAtom n9 = atomList.getAtom(SpeciesTraPPEPhenanthrene.indexCH5);
		n9.getPosition().E(new double[] {sqrt3a, -foura, 0});
		
		IAtom n10 = atomList.getAtom(SpeciesTraPPEPhenanthrene.indexCH6);
		n10.getPosition().E(new double[] {twosqrt3a, -fivea, 0});
		
		IAtom n11 = atomList.getAtom(SpeciesTraPPEPhenanthrene.indexCH7);
		n11.getPosition().E(new double[] {twosqrt3a, a, 0});
		
		IAtom n12 = atomList.getAtom(SpeciesTraPPEPhenanthrene.indexCH8);
		n12.getPosition().E(new double[] {sqrt3a, bond, 0});
		
		IAtom n13 = atomList.getAtom(SpeciesTraPPEPhenanthrene.indexCH9);
		
		n13.getPosition().E(new double[] {threesqrt3a, -foura, 0});
		
		IAtom n14 = atomList.getAtom(SpeciesTraPPEPhenanthrene.indexCH10);
