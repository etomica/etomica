...
public class MolecularModelSKS_SpeciesAlkane  implements IMolecularModel_SpeciesFactory {
	...
	public MolecularModelSKS_SpeciesAlkane(){}
	
	public MolecularModelSKS_SpeciesAlkane(int index){
...
public void setSigmaHSRef(double sigmaHSRef) {
	...
	public static void main(String[] args){
		MolecularModelSKS_SpeciesAlkane lj = new MolecularModelSKS_SpeciesAlkane(3);
