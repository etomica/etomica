...
public class ModelPotParamDisplayTable extends AbstractTableModel  {
	...
	public ModelPotParamDisplayTable(){
	...
	public static void main(String[] args){
		ModelPotParamDisplayTable ljt = new ModelPotParamDisplayTable();
