...
//	}
	...
	public void initializeCoordinates(Box box) {
		...
		if (list.size()==4 && diagramIndex == 0){
			IMolecule mol3 = list.get(2);
			IMolecule mol4 = list.get(3);
			Vector v1 = space.makeVector();
			v1.E(10.0);
	        MoleculeActionTranslateTo translation = new MoleculeActionTranslateTo(space);
	        translation.setDestination(v1);
		...
		} else if (list.size()==4 && diagramIndex == 1){
			IMolecule mol3 = list.get(2);
			IMolecule mol4 = list.get(3);
			Vector v1 = space.makeVector();
			v1.E(10.0);
...
//		 }
	...
	public void initializeCoordinates2(Box box) {
		...
		v1.E(box.getMoleculeList().get(1).getChildList().get(SpeciesWater4P.indexO).getPosition());
		v1.ME(box.getMoleculeList().get(0).getChildList().get(SpeciesWater4P.indexO).getPosition());
		double distance12 = Math.sqrt(v1.squared());
		
		v2.E(box.getMoleculeList().get(2).getChildList().get(SpeciesWater4P.indexO).getPosition());
		v2.ME(box.getMoleculeList().get(1).getChildList().get(SpeciesWater4P.indexO).getPosition());
		double distance23 = Math.sqrt(v2.squared());
		
		v3.E(box.getMoleculeList().get(2).getChildList().get(SpeciesWater4P.indexO).getPosition());
		v3.ME(box.getMoleculeList().get(0).getChildList().get(SpeciesWater4P.indexO).getPosition());
