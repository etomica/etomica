...
public class Virial2CLJmuQ {
    ...
    public static void main(String[] args) {
        ...
        P22CLJmuQ pTarget = new P22CLJmuQ(space, 3.64, 3.64, 112.2, 112.2, mu, Q, .5);
...
sim.getController().runActivityBlocking(ai);
    ...
    public static class Virial2CLJQParam extends ParameterBase {
        ...
        public double sigma = 3.64;
        public double epsilon = 1.0;
        public boolean isCO2 = false;
        public double moment = 1.0;
        double bondL = 2*1.8382;
    }
}
