...
import etomica.potential.P2HardAssociationConeReference;
 ...
 * @author Hye Min Kim
 */
public class DoubleAssociationSitesFluid4Pt {
	...
	public static void main(String[] args) {
		...
		if (args.length == 9) {
            ...
            diagramIndex = Integer.parseInt(args[8]);
		...
		if (sigmaABpoint == 4 && sigmaApoint == 0 && sigmaBpoint == 0 && sigma0point == 0 && diagramIndex == 0) {
		...
		}   else if (sigmaABpoint == 4 && sigmaApoint == 0 && sigmaBpoint == 0 && sigma0point == 0 && diagramIndex == 1){
			bondList[0]=new int [][]{{0,1},{1,2},{2,3},{3,0},{2,0}};
			clusters = (ClusterBonds[])Arrays.addObject(clusters,new ClusterBonds(nBody, bondList, false));
			targetCluster = new ClusterSum(clusters,new double []{1}, new MayerFunction[]{fR,productBond,eR});

		}  else if (sigmaABpoint == 4 && sigmaApoint == 0 && sigmaBpoint == 0 && sigma0point == 0 && diagramIndex == 2) {
			bondList[0]=new int [][]{{0,1},{1,2},{2,3},{3,0},{2,0},{1,3}};
			clusters = (ClusterBonds[])Arrays.addObject(clusters,new ClusterBonds(nBody, bondList, false));
			targetCluster = new ClusterSum(clusters,new double []{1}, new MayerFunction[]{fR,productBond,eR});
			
		}  else if (sigmaABpoint == 2 && sigmaApoint == 1 && sigmaBpoint == 1 && sigma0point == 0 && diagramIndex == 0) {
			bondList[0] = new int [][]{{1,2},{2,3},{3,0}};
			bondList[1] = new int [][]{{0,1}};
			clusters = (ClusterBonds[])Arrays.addObject(clusters,new ClusterBonds(nBody, bondList, false));
			targetCluster = new ClusterSum(clusters,new double []{1}, new MayerFunction[]{fR,productBond,eR});			
			
		}  else if (sigmaABpoint == 2 && sigmaApoint == 1 && sigmaBpoint == 1 && sigma0point == 0 && diagramIndex == 1) {
			bondList[0] = new int [][]{{1,2},{2,3},{3,0},{2,0}};
			bondList[1] = new int [][]{{0,1}};
			clusters = (ClusterBonds[])Arrays.addObject(clusters,new ClusterBonds(nBody, bondList, false));
			targetCluster = new ClusterSum(clusters,new double []{1}, new MayerFunction[]{fR,productBond,eR});
			
		}  else if (sigmaABpoint == 2 && sigmaApoint == 1 && sigmaBpoint == 1 && sigma0point == 0 && diagramIndex == 2) {
			bondList[0] = new int [][]{{0,1},{1,2},{2,3},{3,0}};
			bondList[1] = new int [][]{{2,0}};
			clusters = (ClusterBonds[])Arrays.addObject(clusters,new ClusterBonds(nBody, bondList, false));
			targetCluster = new ClusterSum(clusters,new double []{1}, new MayerFunction[]{fR,productBond,eR});
			
		}  else if (sigmaABpoint == 2 && sigmaApoint == 1 && sigmaBpoint == 1 && sigma0point == 0 && diagramIndex == 3) {
			bondList[0] = new int [][]{{1,2},{2,3},{3,0},{2,0},{1,3}};
			bondList[1] = new int [][]{{0,1}};
			clusters = (ClusterBonds[])Arrays.addObject(clusters,new ClusterBonds(nBody, bondList, false));
			targetCluster = new ClusterSum(clusters,new double []{1}, new MayerFunction[]{fR,productBond,eR});
			
		}  else if (sigmaABpoint == 0 && sigmaApoint == 2 && sigmaBpoint == 2 && sigma0point == 0 && diagramIndex == 0) {
			bondList[0] = new int [][]{{1,2},{3,0}};
			bondList[1] = new int [][]{{0,1},{2,3}};
			clusters = (ClusterBonds[])Arrays.addObject(clusters,new ClusterBonds(nBody, bondList, false));
			targetCluster = new ClusterSum(clusters,new double []{1}, new MayerFunction[]{fR,productBond,eR});
			
		}  else if (sigmaABpoint == 0 && sigmaApoint == 2 && sigmaBpoint == 2 && sigma0point == 0 && diagramIndex == 1) {
			bondList[0] = new int [][]{{1,2},{3,0},{2,0}};
			bondList[1] = new int [][]{{0,1},{2,3}};
			clusters = (ClusterBonds[])Arrays.addObject(clusters,new ClusterBonds(nBody, bondList, false));
			targetCluster = new ClusterSum(clusters,new double []{1}, new MayerFunction[]{fR,productBond,eR});
			
		}  else if (sigmaABpoint == 0 && sigmaApoint == 2 && sigmaBpoint == 2 && sigma0point == 0 && diagramIndex == 2) {
			bondList[0] = new int [][]{{1,2},{3,0},{2,0},{3,1}};
			bondList[1] = new int [][]{{0,1},{2,3}};
			clusters = (ClusterBonds[])Arrays.addObject(clusters,new ClusterBonds(nBody, bondList, false));
			targetCluster = new ClusterSum(clusters,new double []{1}, new MayerFunction[]{fR,productBond,eR});
			
		}  else if (sigmaABpoint == 1 && sigmaApoint == 1 && sigmaBpoint == 1 && sigma0point == 1 && diagramIndex == 0) {
			...
			double ec2 = ec1*ec1; 
			HSB[4] = -Math.pow(4.0/3.0*Math.PI*(sigma)*(sigma)*(sigma), 3)*Math.pow(3.0/4.0*(1.0/3.0*(ec1-ec1*ec2)+2.0/3.0-ec1+1.0/3.0*ec1*ec2),4)*2.0;
			int [][][]refBondList = new int [][][]{{{0,1},{1,2}},{{0,2}},{{2,3}}};
			ClusterBonds refBonds = new ClusterBonds(4,refBondList, false);
			refCluster = new ClusterSum(new ClusterBonds[]{refBonds}, new double []{1}, new MayerFunction[]{fRef4mer,eRef,fRef});
			refCluster.setTemperature(temperature);
		...
		}  else if (sigmaABpoint == 1 && sigmaApoint == 1 && sigmaBpoint == 1 && sigma0point == 1 && diagramIndex == 1) {
			System.out.println("The reference system is a chain configuration");
			chainIndex = 1;
			P2HardAssociationConeReference pRef = new P2HardAssociationConeReference(space, sigma);
			P2MoleculeMonatomic pMoleculeRef = new P2MoleculeMonatomic(pRef);
		...
		}  else if (sigmaABpoint == 1 && sigmaApoint == 1 && sigmaBpoint == 1 && sigma0point == 1 && diagramIndex == 2) {
			System.out.println("The reference system is a chain configuration");
			chainIndex = 1;
			P2HardAssociationConeReference pRef = new P2HardAssociationConeReference(space, sigma);
			P2MoleculeMonatomic pMoleculeRef = new P2MoleculeMonatomic(pRef);
		...
		}  else if (sigmaABpoint == 1 && sigmaApoint == 1 && sigmaBpoint == 1 && sigma0point == 1 && diagramIndex == 3) {
			System.out.println("The reference system is a chain configuration");
			chainIndex = 1;
			P2HardAssociationConeReference pRef = new P2HardAssociationConeReference(space, sigma);
			P2MoleculeMonatomic pMoleculeRef = new P2MoleculeMonatomic(pRef);
			...
			refCluster = new ClusterSum(new ClusterBonds[]{refBonds}, new double []{1}, new MayerFunction[]{fRef4mer,eRef,fRef});
			refCluster.setTemperature(temperature);
			bondList[0] = new int [][]{{1,3},{2,3},{3,0}};
			bondList[1] = new int [][]{{0,1},{1,2}};
			clusters = (ClusterBonds[])Arrays.addObject(clusters,new ClusterBonds(nBody, bondList, false));
			ClusterCriteria criteria = new ClusterCriteria() {
				public boolean isValid(double[][][] values) {
		...
		}  else if (sigmaABpoint == 1 && sigmaApoint == 1 && sigmaBpoint == 1 && sigma0point == 1 && diagramIndex == 4) {
			System.out.println("The reference system is a chain configuration");
			chainIndex = 1;
			P2HardAssociationConeReference pRef = new P2HardAssociationConeReference(space, sigma);
			P2MoleculeMonatomic pMoleculeRef = new P2MoleculeMonatomic(pRef);
			...
			refCluster = new ClusterSum(new ClusterBonds[]{refBonds}, new double []{1}, new MayerFunction[]{fRef4mer,eRef,fRef});
			refCluster.setTemperature(temperature);
			bondList[0] = new int [][]{{1,3},{2,3},{3,0},{2,0}};
			bondList[1] = new int [][]{{0,1},{1,2}};
			clusters = (ClusterBonds[])Arrays.addObject(clusters,new ClusterBonds(nBody, bondList, false));
			ClusterCriteria criteria = new ClusterCriteria() {
				public boolean isValid(double[][][] values) {
		...
		}  else if (sigmaABpoint == 0 && sigmaApoint == 1 && sigmaBpoint == 1 && sigma0point == 2 && diagramIndex == 0) {
			System.out.println("The reference system is a chain configuration");
			chainIndex = 1;
			P2HardAssociationConeReference pRef = new P2HardAssociationConeReference(space, sigma);
			P2MoleculeMonatomic pMoleculeRef = new P2MoleculeMonatomic(pRef);
			...
			double ec1 = Math.cos(etomica.units.Degree.UNIT.toSim(27.0));
			double ec2 = ec1*ec1; 
			HSB[4] = -Math.pow(4.0/3.0*Math.PI*(sigma)*(sigma)*(sigma), 3)*Math.pow(3.0/4.0*(1.0/3.0*(ec1-ec1*ec2)+2.0/3.0-ec1+1.0/3.0*ec1*ec2),6)*2.0;
			int [][][]refBondList = new int [][][]{{{0,1},{1,2},{2,3}},{{0,2},{1,3},{0,3}}};
			ClusterBonds refBonds = new ClusterBonds(4,refBondList, false);

			refCluster = new ClusterSum(new ClusterBonds[]{refBonds}, new double []{1}, new MayerFunction[]{fRef4mer,eRef});
			refCluster.setTemperature(temperature);
			bondList[0] = new int [][]{{0,3}};
			bondList[1] = new int [][]{{0,1},{1,2},{2,3}};
			clusters = (ClusterBonds[])Arrays.addObject(clusters,new ClusterBonds(nBody, bondList, false));
			ClusterCriteria criteria = new ClusterCriteria() {
				public boolean isValid(double[][][] values) {
					
					return values[0][3][2] > 1 && values[2][0][2] > 1 && values[1][3][2] > 1;//atoms shouldn't be overlapped, e-bond should be greater than 1
				}
			};
			targetCluster = new ClusterSum(clusters,new double []{1}, new MayerFunction[]{fR,productBond,eR});
			
		}  else if (sigmaABpoint == 0 && sigmaApoint == 1 && sigmaBpoint == 1 && sigma0point == 2 && diagramIndex == 1) {
			System.out.println("The reference system is a chain configuration");
			chainIndex = 1;
			P2HardAssociationConeReference pRef = new P2HardAssociationConeReference(space, sigma);
			P2MoleculeMonatomic pMoleculeRef = new P2MoleculeMonatomic(pRef);
		...
		}  else if (sigmaABpoint == 0 && sigmaApoint == 1 && sigmaBpoint == 1 && sigma0point == 2 && diagramIndex == 2) {
			System.out.println("The reference system is a chain configuration");
			chainIndex = 1;
			P2HardAssociationConeReference pRef = new P2HardAssociationConeReference(space, sigma);
			P2MoleculeMonatomic pMoleculeRef = new P2MoleculeMonatomic(pRef);
			...
			refCluster = new ClusterSum(new ClusterBonds[]{refBonds}, new double []{1}, new MayerFunction[]{fRef4mer,eRef});
			refCluster.setTemperature(temperature);
			bondList[0] = new int [][]{{0,3},{2,0},{1,3}};
			bondList[1] = new int [][]{{0,1},{1,2},{2,3}};
			clusters = (ClusterBonds[])Arrays.addObject(clusters,new ClusterBonds(nBody, bondList, false));
			ClusterCriteria criteria = new ClusterCriteria() {
				public boolean isValid(double[][][] values) {
		...
		}  else if (sigmaABpoint == 0 && sigmaApoint == 1 && sigmaBpoint == 1 && sigma0point == 2 && diagramIndex == 3) {
			System.out.println("The reference system is a chain configuration");
			chainIndex = 1;
			P2HardAssociationConeReference pRef = new P2HardAssociationConeReference(space, sigma);
			P2MoleculeMonatomic pMoleculeRef = new P2MoleculeMonatomic(pRef);
...
//        sim.setRefPref(1.0082398078547523);
        sim.initRefPref(refFileName, numSteps/10);//default numSteps/10
