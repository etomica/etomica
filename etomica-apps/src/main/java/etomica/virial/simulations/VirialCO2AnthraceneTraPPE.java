...
public class VirialCO2AnthraceneTraPPE {
    ...
    public static void main(String[] args) {
        ...
        pCO2An.addPotential(pC_C, ApiBuilder.makeIntergroupTypeIterator(new IAtomType[]{typeC_CO2, typeC}));
        pCO2An.addPotential(pC_CH, ApiBuilder.makeIntergroupTypeIterator(new IAtomType[]{typeC_CO2, typeCH}));
        pCO2An.addPotential(pO_C, ApiBuilder.makeIntergroupTypeIterator(new IAtomType[]{typeO, typeC}));
        pCO2An.addPotential(pO_CH, ApiBuilder.makeIntergroupTypeIterator(new IAtomType[]{typeO, typeCH}));
