...
public class VirialjackCell {
    ...
    public static void main(String[] args) {
        ...
        NeighborCellManager targetCellManager = new NeighborCellManager(sm,sim.box[1],2,bondingInfo,true);/*{
            public NeighborIterator makeNeighborIterator() {
                return new NeighborIteratorCellFaster(this,sim.box[1]);
            }
        };*/
        NeighborCellManager referenceCellManager = new NeighborCellManager(sm,sim.box[0],2,bondingInfo,true);/*{
            public NeighborIterator makeNeighborIterator() {
       ...
       angleMoves[0].setFixedCOM(false);
        ...
        if (false){
           ...
           plotRadiusGyration.setLegend(new DataTag[]{historyRadisGyration.getTag()},"Rg2");
            ...
            MeterPotentialEnergy meterPotentialEnergy = new MeterPotentialEnergy(sim.integrators[1].getPotentialCompute());
