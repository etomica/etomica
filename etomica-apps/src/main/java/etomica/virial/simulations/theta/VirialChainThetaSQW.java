        ...
        if (nSpheres >= 3) {
            ...
            if (nSpheres < 6 || doLattice) {
                ...
                angleMove2 = new MCMoveClusterAngle(pc, space, bonding, sim.getRandom(), 1,
                        new MCMoveClusterAngle.AtomChooserStartStop(sim.getRandom(),nSpheres/4, nSpheres));
                ...
                angleMove2 = new MCMoveClusterAngle(pc, space, bonding, sim.getRandom(), 1,
                        new MCMoveClusterAngle.AtomChooserStartStop(sim.getRandom(),nSpheres/8, nSpheres/4 ));
                angleMove2.setBox(sim.box());
                ...
                angleMove3 = new MCMoveClusterAngle(pc, space, bonding, sim.getRandom(), 1,
                        new MCMoveClusterAngle.AtomChooserStartStop(sim.getRandom(),nSpheres/4, 3 * nSpheres/8 ));
                ...
                angleMove4 = new MCMoveClusterAngle(pc, space, bonding, sim.getRandom(), 1,
                        new MCMoveClusterAngle.AtomChooserStartStop(sim.getRandom(),3 * nSpheres/8, nSpheres ));
