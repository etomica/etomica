...
public static void main(String[] args) {
        ...
        IAtomType typeSF6 = speciesSF6.getAtomType(0);
        ...
        pSF6Alkane.addPotential(pSF6_CH3, ApiBuilder.makeIntergroupTypeIterator(new IAtomType[]{typeSF6, typeCH3}));

        pSF6Alkane.addPotential(pSF6_CH2, ApiBuilder.makeIntergroupTypeIterator(new IAtomType[]{typeSF6, typeCH2}));
