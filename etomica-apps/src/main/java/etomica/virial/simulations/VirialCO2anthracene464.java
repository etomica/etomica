 ...
 * 
 */
public class VirialCO2anthracene464 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("CO2(single) + anthracene(464 model) B"+nTypes[0]+""+nTypes[1]+" at T="+temperature+" Kelvin");
        ...
        //this is  solute-solute potential 
        //there are two kinds of benzene rings. i.e. two kinds of interaction sites
        // name them as C and CH, C is "6"and CH is "4" 
        double sigmaC = 5.502;
       ...
       //make a potential group for anthracene
        ...
        double epsilonC_C = Kelvin.UNIT.toSim(284.9);
        double epsilonC_CH = Kelvin.UNIT.toSim(181.1);
