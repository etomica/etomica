...
import etomica.virial.mcmove.MCMoveClusterTorsionMultiFasterer;
 ...
 *   March 2013
 */
public class VirialAlkaneFasterer {
    ...
    public static void main(String[] args) {
        ...
        MCMoveClusterTorsionMultiFasterer[] torsionMoves = null;
        
        if (nSpheres > 3) {
            torsionMoves = new MCMoveClusterTorsionMultiFasterer[2];
            torsionMoves[0] = new MCMoveClusterTorsionMultiFasterer(sim.integratorsFasterer[0].getPotentialCompute(), space, sim.getRandom(), p4, 40);
            torsionMoves[0].setBox(sim.box[0]);
            torsionMoves[0].setTemperature(temperature);
            sim.integratorsFasterer[0].getMoveManager().addMCMove(torsionMoves[0]);
            torsionMoves[1] = new MCMoveClusterTorsionMultiFasterer(sim.integratorsFasterer[1].getPotentialCompute(), space, sim.getRandom(), p4, 40);
            torsionMoves[1].setBox(sim.box[1]);
            torsionMoves[1].setTemperature(temperature);
            sim.integratorsFasterer[1].getMoveManager().addMCMove(torsionMoves[1]);
        }
