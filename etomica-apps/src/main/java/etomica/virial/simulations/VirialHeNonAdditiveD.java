...
public class VirialHeNonAdditiveD {
    ...
    public static void main(String[] args) {
        ...
        boolean subtractApprox = false;
        boolean calcApprox = true;
        boolean semiClassical = true;
        if (subtractApprox) {
        ...
        fNA[3] = f3Target;
        ClusterWheatleyMultibody fullTargetCluster = null; //new ClusterWheatleyMultibodyDerivatives(nPoints, fTarget, fNA);
