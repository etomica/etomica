...
public class VirialAlkaneMix2 {
    ...
    public static void main(String[] args) {
        ...
        double rmCH3CH2 = 0.5*(rmCH3 + rmCH2);
        ...
        double rmaxCH3CH2 = 0.5*(rmaxCH3 + rmaxCH2);
       ...
       /* for (int i=5; i<100;i++){
        ...
        final SimulationVirialOverlap2 sim = new SimulationVirialOverlap2(
                space,
                species,
                new int[]{nComp1, nComp2},
                temperature,
                refCluster,
                targetCluster
        );
        sim.setDoWiggle(nSpheres1 > 2 || nSpheres2 > 2);
        sim.init();
...
//        sim.integratorOS.setStepFreq0(1);
        ...
        pComp1Comp1Group.addPotential(p2CH2, ApiBuilder.makeIntergroupTypeIterator(new AtomType[]{typeCH2A, typeCH2A}));
        pComp1Comp1Group.addPotential(p2CH3, ApiBuilder.makeIntergroupTypeIterator(new AtomType[]{typeCH3A, typeCH3A}));
        pComp1Comp1Group.addPotential(p2CH3CH2, ApiBuilder.makeIntergroupTypeIterator(new AtomType[]{typeCH3A, typeCH2A}));
        pComp1Comp1Group.addPotential(p2CH3CH2, ApiBuilder.makeIntergroupTypeIterator(new AtomType[]{typeCH2A, typeCH3A}));

        pComp2Comp2Group.addPotential(p2CH2, ApiBuilder.makeIntergroupTypeIterator(new AtomType[]{typeCH2B, typeCH2B}));
        pComp2Comp2Group.addPotential(p2CH3, ApiBuilder.makeIntergroupTypeIterator(new AtomType[]{typeCH3B, typeCH3B}));
        pComp2Comp2Group.addPotential(p2CH3CH2, ApiBuilder.makeIntergroupTypeIterator(new AtomType[]{typeCH3B, typeCH2B}));
        pComp2Comp2Group.addPotential(p2CH3CH2, ApiBuilder.makeIntergroupTypeIterator(new AtomType[]{typeCH2B, typeCH3B}));

        pComp1Comp2Group.addPotential(p2CH2, ApiBuilder.makeIntergroupTypeIterator(new AtomType[]{typeCH2A, typeCH2B}));
        pComp1Comp2Group.addPotential(p2CH3, ApiBuilder.makeIntergroupTypeIterator(new AtomType[]{typeCH3A, typeCH3B}));
