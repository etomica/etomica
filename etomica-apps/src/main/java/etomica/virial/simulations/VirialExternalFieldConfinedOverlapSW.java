...
import etomica.virial.MeterVirialExternalFieldOverlapConfinedSW;
 ...
 */
public class VirialExternalFieldConfinedOverlapSW {
    ...
    public static void runVirial(VirialExternalFieldParam params) {
        ...
        System.out.println("External Field overlap sampling B*"+nPoints+" at T="+temperature);
		...
		MeterVirialExternalFieldOverlapConfinedSW meter = new MeterVirialExternalFieldOverlapConfinedSW(refDiagrams, fTarget, walldistance, lambdaWF, temperature, epsilonWF );
