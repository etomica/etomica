...
public class MappedUFasterer extends Simulation {
    ...
    public MappedUFasterer(Space _space, int numAtoms, double temperature, double density, double rc) {
        super(_space);
    ...
    public static void main(String[] args) throws IOException {
        ...
        MappedUFasterer sim = new MappedUFasterer(space, numAtoms, temperature, density, rc);
        ...
        if (computeUMA){
            final MeterMappedUFasterer meterMappedU = new MeterMappedUFasterer(sim.integrator.getPotentialCompute(), sim.box, nBins);
