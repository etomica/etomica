...
public class MeterMeanForceFasterer implements IDataSource, DataSourceIndependent, IAction {
    ...
    public MeterMeanForceFasterer(PotentialCompute potentialMaster, Potential2SoftSpherical p2, Box box, int nbins) {
        this.p2 = p2;
        this.box = box;
