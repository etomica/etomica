...
public class AutoMOPUpgrade {
    ...
    //return modified MOP for all geometries
    public SpeciesBuilder getAutoMOPModified(Space space, String struc, String structName, ISpecies species, Box box,ArrayList<ArrayList<Integer>> connectivity, Map<Integer, String> map, boolean setMOPMassInfinite, boolean setDynamic){
        ...
        int numEdges = 0, numFaces = 0, numVertices = 0;
        ...
        numVertices = 2 + numEdges - numFaces;
        ...
        if(arrayListMetals.size() > 2){
            for (int i =0; i <  arrayListMetals.size(); i++){
                System.out.println(molecule.getChildList().get(arrayListMetals.get(i)).getType());
            }
            throw  new RuntimeException(" check metal type" );
        }
        ...
        double coordinateMultiplier= Math.sqrt(posntTwo.Mv1Squared(posnOne));
        ...
        makeConnectivityMOP(box, connectivity, connectivityMOP, map, atomMapMOP);
        removeExcessMetal(box, atomMapMOP, connectivity, connectivityMOP,arrayListMetals, metalMoleculeMap);
        SpeciesBuilder speciesBuilder = makeCompleteMOP(box, species, connectivity,map, oldNewAtomNumMap, connectivityMOP, atomMapMOP, metalAtomsNew, metalAtomsConnect, typeMapNew, setMOPMassInfinite,setDynamic  );
    ...
    public List<Integer[]> getStrucListAct(String struc){
        Map<Double, List<Integer[]>> distMap = new HashMap<>();
        List<Integer[]>distEqual = new ArrayList<>();
        AutoMOPUpgrade autoMOP = new AutoMOPUpgrade();
        List<Vector> listVectorTetra = new ArrayList<>();
        ...
        if (struc.equals("tetra")){
            ...
            Vector vec0 = Vector.of(C0, -C0,  C0);
            Vector vec1 = Vector.of(C0,  C0, -C0);
            Vector vec2 = Vector.of(-C0, C0,  C0);
            Vector vec3 = Vector.of(-C0,-C0, -C0);
            listVectorTetra.add(vec0);
            listVectorTetra.add(vec1);
            listVectorTetra.add(vec2);
            listVectorTetra.add(vec3);
            intArray = new Integer[]{0, 1, 2};
            distEqual.add(intArray);
            intArray = new Integer[]{1, 0, 3};
            distEqual.add(intArray);
            intArray = new Integer[]{2, 3, 0};
            distEqual.add(intArray);
            intArray = new Integer[]{3, 2, 1};
            distEqual.add(intArray);
            setVecPositionList(listVectorTetra);
        } else if (struc.equals("octa")) {
            ...
            Vector vec0 = Vector.of(0.5,  0.5,  0.5);
            Vector vec1 = Vector.of(0.5,  0.5, -0.5);
            Vector vec2 = Vector.of(0.5, -0.5,  0.5);
            Vector vec3 = Vector.of(0.5, -0.5, -0.5);
            Vector vec4 = Vector.of(-0.5,  0.5,  0.5);
            Vector vec5 = Vector.of(-0.5,  0.5, -0.5);
            Vector vec6 = Vector.of(-0.5, -0.5,  0.5);
            Vector vec7 = Vector.of(-0.5, -0.5, -0.5);
            listVectorTetra.add(vec0);
            listVectorTetra.add(vec1);
            listVectorTetra.add(vec2);
            listVectorTetra.add(vec3);
            listVectorTetra.add(vec4);
            listVectorTetra.add(vec5);
            listVectorTetra.add(vec6);
            listVectorTetra.add(vec7);
            intArray = new Integer[]{0, 1, 5, 4};
            distEqual.add(intArray);
            intArray = new Integer[]{0, 4, 6, 2};
            distEqual.add(intArray);
            intArray = new Integer[]{0, 2, 3, 1};
            distEqual.add(intArray);
            intArray = new Integer[]{7, 3, 2, 6};
            distEqual.add(intArray);
            intArray = new Integer[]{7, 6, 4, 5};
            distEqual.add(intArray);
            intArray = new Integer[]{7, 5, 1, 3};
            distEqual.add(intArray);
            setVecPositionList(listVectorTetra);
        }else if (struc.equals("icosa")) {
            ...
            Vector vec0 = Vector.of(0.0,  0.5,   C1);
            Vector vec1 = Vector.of(0.0,  0.5,  -C1);
            Vector vec2 = Vector.of(0.0, -0.5,   C1);
            Vector vec3 = Vector.of(0.0, -0.5,  -C1);
            Vector vec4 = Vector.of(C1,  0.0,  0.5);
            Vector vec5 = Vector.of(C1,  0.0, -0.5);
            Vector vec6 = Vector.of(-C1,  0.0,  0.5);
            Vector vec7 = Vector.of(-C1,  0.0, -0.5);
            Vector vec8 = Vector.of(0.5,   C1,  0.0);
            Vector vec9 = Vector.of(0.5,  -C1,  0.0);
            Vector vec10 = Vector.of(-0.5,   C1,  0.0);
            Vector vec11 = Vector.of(-0.5,  -C1,  0.0);
            Vector vec12 = Vector.of(C0,   C0,   C0);
            Vector vec13 = Vector.of(C0,   C0,  -C0);
            Vector vec14 = Vector.of(C0,  -C0,   C0);
            Vector vec15 = Vector.of(C0,  -C0,  -C0);
            Vector vec16 = Vector.of(-C0,   C0,   C0);
            Vector vec17 = Vector.of(-C0,   C0,  -C0);
            Vector vec18 = Vector.of(-C0,  -C0,   C0);
            Vector vec19 = Vector.of(-C0,  -C0,  -C0);
            listVectorTetra.add(vec0);
            listVectorTetra.add(vec1);
            listVectorTetra.add(vec2);
            listVectorTetra.add(vec3);
            ...
            listVectorTetra.add(vec6);
            listVectorTetra.add(vec7);
            listVectorTetra.add(vec8);
            listVectorTetra.add(vec9);
            listVectorTetra.add(vec10);
            listVectorTetra.add(vec11);
            listVectorTetra.add(vec12);
            listVectorTetra.add(vec13);
            listVectorTetra.add(vec14);
            listVectorTetra.add(vec15);
            listVectorTetra.add(vec16);
            listVectorTetra.add(vec17);
            listVectorTetra.add(vec18);
            listVectorTetra.add(vec19);
            intArray = new Integer[]{};
            distEqual.add(intArray);
            intArray = new Integer[]{0,  2, 14,  4, 12};
            distEqual.add(intArray);
            intArray = new Integer[]{0, 12,  8, 10, 16};
            distEqual.add(intArray);
            intArray = new Integer[]{0, 16,  6, 18,  2};
            distEqual.add(intArray);
            intArray = new Integer[]{7,  6, 16, 10, 17};
            distEqual.add(intArray);
            intArray = new Integer[]{7, 17,  1,  3, 19};
            distEqual.add(intArray);
            intArray = new Integer[]{7, 19, 11, 18,  6};
            distEqual.add(intArray);
            intArray = new Integer[]{9, 11, 19,  3, 15};
            distEqual.add(intArray);
            intArray = new Integer[]{9, 15,  5,  4, 14};
            distEqual.add(intArray);
            intArray = new Integer[]{9, 14,  2, 18, 11};
            distEqual.add(intArray);
            intArray = new Integer[]{13,  1, 17, 10,  8};
            distEqual.add(intArray);
            intArray = new Integer[]{13,  8, 12,  4,  5};
            distEqual.add(intArray);
            intArray = new Integer[]{13,  5, 15,  3,  1};
            distEqual.add(intArray);
            setVecPositionList(listVectorTetra);
        }else if (struc.equals("dodeca")) {
            Integer[] intArray = new Integer[3];
    ...
    public void removeExcessMetal (Box box, Map<Integer, String> atomMOPMap, ArrayList<ArrayList<Integer>> connectivityLigand, ArrayList<ArrayList<Integer>> connectivityMOP, ArrayList<Integer> arrayListMetals, Map<Integer, List<Integer>> metalMoleculeMap){
        IMoleculeList moleculeList = box.getMoleculeList();
    ...
    public Box getMOPFace(Box box,String struc, String strucName, ISpecies species, ArrayList<ArrayList<Integer>> connectivity, Map<Integer, String> map,List<Integer[]> linkedVertices, ArrayList<Integer> arrayListExtremities, ArrayList<Integer> arrayListLinkerOxy, ArrayList<Integer> arrayListLinkerCarb, int numEdges, int numFaces, double dist, ArrayList<Vector> moleculeProjection){
        AutoMOPUpgrade autoMOP = new AutoMOPUpgrade();
        List<Integer[]> faces = new ArrayList<>();
        List<Vector> vertices = new ArrayList<>();
        Map<Integer, List<Integer[]>> faceEdges = new HashMap<>();
   ...
   /* public Map<Double, List<Integer[]>> edgeBetweenPoints ( Map<Double, List<Integer[]>> distMap, List<Vector> listVect){
    ...
    public List<Integer[]> getStrucListActNew(String struc){
        Map<Double, List<Integer[]>> distMap = new HashMap<>();
        List<Integer[]>distEqual = new ArrayList<>();
        AutoMOPUpgrade autoMOP = new AutoMOPUpgrade();
        List<Vector> listVectorTetra = new ArrayList<>();
