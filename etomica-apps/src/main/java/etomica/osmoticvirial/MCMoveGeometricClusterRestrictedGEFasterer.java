 ...
 */
public class MCMoveGeometricClusterRestrictedGEFasterer extends MCMove {
     ...
     */
    public MCMoveGeometricClusterRestrictedGEFasterer(NeighborManager neighborManager1, NeighborManager neighborManager2,
