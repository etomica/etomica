 ...
 */
public class AshtonWildingOsmoticVirialFasterer extends Simulation {

    protected Box box;
    protected Potential2Soft potential1, potential2, potential12;
    protected IntegratorMCFasterer integrator;
    protected MCMoveAtomFasterer mcMoveAtom;
    protected MCMoveInsertDeleteFasterer mcMoveInsertDelete;
    protected MCMoveGeometricClusterFasterer mcMoveGeometricCluster;
    ...
    public AshtonWildingOsmoticVirialFasterer(int numAtoms, double vf, double q, boolean computeIdeal, double L, double GCfreq, boolean graphics){
        ...
        if(!computeIdeal && vf != 0) {
            mcMoveInsertDelete = new MCMoveInsertDeleteFasterer(potentialMaster, random, space);
...
//              mu = Double.MAX_VALUE;
            ...
            mcMoveGeometricCluster = new MCMoveGeometricClusterFasterer(potentialMaster, neighborManager, space, random, integrator,
