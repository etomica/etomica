 ...
 */
public class DCVGCMDFasterer extends Simulation {

    public IntegratorDCVGCMDFasterer integratorDCV;
    public P1WCAWallFasterer potentialwall;
    public P1WCAWallFasterer potentialwall1;
    ...
    public MeterFluxFasterer meterFlux0, meterFlux1, meterFlux2, meterFlux3;
    ...
    private DCVGCMDFasterer(Space _space) {
        ...
        PotentialMasterCellFasterer potentialMasterCell = new PotentialMasterCellFasterer(getSpeciesManager(), box, 1, BondingInfo.noBonding());
        PotentialMasterListFasterer potentialMasterList = new PotentialMasterListFasterer(getSpeciesManager(), box, 1, rc * neighborRangeFac, BondingInfo.noBonding());
        ...
        potentialwall = new P1WCAWallFasterer(box, sigma, epsilon);
        ...
        final IntegratorVelocityVerletFasterer integratorMD = new IntegratorVelocityVerletFasterer(pcAggMD, this.getRandom(), 0.001, 1.0, box);
        final IntegratorMCFasterer integratorMC = new IntegratorMCFasterer(pcAggMC, random, 1.0, box);
        ...
        MyMCMoveFasterer[] moves = integratorDCV.mcMoves();
        ...
        meterFlux0 = new MeterFluxFasterer(moves[0], integratorDCV);
        meterFlux1 = new MeterFluxFasterer(moves[1], integratorDCV);
        meterFlux2 = new MeterFluxFasterer(moves[2], integratorDCV);
        meterFlux3 = new MeterFluxFasterer(moves[3], integratorDCV);
        meterFlux0.setBox(box);
        meterFlux1.setBox(box);
        meterFlux2.setBox(box);
        meterFlux3.setBox(box);
        fluxMeters = new DataSourceGroup(new MeterFluxFasterer[]{meterFlux0, meterFlux1, meterFlux2, meterFlux3});
