...
public class WaterDropletFasterer {
...
//        System.out.println("o at "+((IAtomPositioned)box.getLeafList().getAtom(2)).getPosition());
        ...
        if (true) {
            ...
            MeterEnergyFromIntegratorFasterer meterE = new MeterEnergyFromIntegratorFasterer(integrator);
            AccumulatorHistory history = new AccumulatorHistory(new HistoryCollapsingAverage());
            history.setTimeDataSource(new DataSourceCountTimeFasterer(integrator));
