...
public class WaterDropletShakeFasterer {
    ...
    public static SimulationGraphic makeWaterDroplet() {
        ...
        final IntegratorVelocityVerletFasterer integrator = new IntegratorVelocityVerletFasterer(potentialMaster, sim.getRandom(), timeInterval, Kelvin.UNIT.toSim(271.2654804973), box);
...
//        System.out.println("o at "+((IAtomPositioned)box.getLeafList().getAtom(2)).getPosition());
        ...
        if (true) {
            ...
            MeterEnergyFromIntegratorFasterer meterEnergy = new MeterEnergyFromIntegratorFasterer(integrator);
            ...
            MeterPotentialEnergyFromIntegratorFasterer meterPE = new MeterPotentialEnergyFromIntegratorFasterer(integrator);
