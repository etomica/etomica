...
public class MeterMappedAveragingFreeEnergyFasterer extends DataSourceScalar {
    ...
    public MeterMappedAveragingFreeEnergyFasterer(Box box, double temperature, double interactionS, double dipoleMagnitude, PotentialCompute potentialMaster, NeighborManager nbrManager) {
