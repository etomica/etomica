...
public class MeterEnergyMeanFieldFasterer implements IDataSource {
...
//    protected double[] dtdotdtheta0 = new double[0];
    ...
    public MeterEnergyMeanFieldFasterer(Space space, Box box, double J, NeighborManager nbrManager, double temperature) {
