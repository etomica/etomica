...
public class PotentialCallbackPhiSumHeisenbergFasterer implements PotentialCallback {
    ...
    public PotentialCallbackPhiSumHeisenbergFasterer(Space space, AtomLeafAgentManager<MoleculeAgent> leafAgentManager) {
        ei = space.makeVector();
        ej = space.makeVector();
