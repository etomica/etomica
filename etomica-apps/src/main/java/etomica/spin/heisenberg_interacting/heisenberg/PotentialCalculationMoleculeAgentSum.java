...
//System.out.println("Acos eix = " + Math.acos(ei.getX(0)));
        ...
        //TODO feels like f is already computed~~~~
//        double f1 = bt * agentAtom1.torque.getX(0);
//        double f2 = bt * agentAtom2.torque.getX(0);

        //bt*u = - bJ * Cos(t1-t2)  & f = -dbt*U/dtheta
        double f1 = -bJ* Math.sin(t1-t2);
        double f2 = -f1;
        agentAtom1.btForce().PE(f1);
        agentAtom2.btForce().PE(f2);



//        double p12 = -bJ * ei.dot(ej);
//        double p21 = p12;
//        double p11 = bt * agentAtom1.phi.getX(0);
//        double p22 = bt * agentAtom2.phi.getX(0);

        double phi11 = bJ* Math.cos(t1-t2);
        double phi22 = phi11;
        agentAtom1.btPhi().PE(phi11);
        agentAtom2.btPhi().PE(phi22);
...
//        agentAtom1.fEx().PE(fxE1);
//        agentAtom1.fEy().PE(fyE1);
