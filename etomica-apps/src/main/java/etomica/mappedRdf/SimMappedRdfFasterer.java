 ...
 */
public class SimMappedRdfFasterer extends Simulation {
    ...
    public SimMappedRdfFasterer(Space _space, int numAtoms, double temperature, double density, double rc) {
        super(_space);
    ...
    public static void main(String[] args) {
        ...
        SimMappedRdfFasterer sim = new SimMappedRdfFasterer(space, numAtoms, temperature, density, rc);

        MeterRDF  meterRDF = null;
        MeterMappedRdfFasterer meterMappedRdf = null;
        ...
        meterMappedRdf = new MeterMappedRdfFasterer(rcforHandfinmap, sim.integrator.getPotentialCompute(), sim.box, nbins, density);
