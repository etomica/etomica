 ...
 */
public class MeterMappedRdfFasterer implements IDataSource, DataSourceIndependent {
    ...
    public MeterMappedRdfFasterer(double rcforHandfinmap, PotentialCompute potentialMaster, Box box, int nbins, double density) {
        this.box = box;
