...
/**
 * Velocity function for evaluation of the singlet density for a monatomic crystal via harmonically mapped averaging.
 * Formulation is based on a Gaussian reference density. Assumes singlet density is measured using two signals points
 * (delta functions) arranged on opposite sides of the lattice site.
 *
 * @author David Kofke
 */
