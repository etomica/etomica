 ...
 */
public class MCMoveBondLengthFasterer extends MCMoveMoleculeFasterer {
    ...
    public MCMoveBondLengthFasterer(PotentialCompute potentialMaster, IRandom random, Box box, int armLength) {
        this(potentialMaster, random, box, 1.0, armLength);
    }

    public MCMoveBondLengthFasterer(PotentialCompute potentialMaster,
