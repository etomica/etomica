 ...
 */
public class MCMoveRotateArmFasterer extends MCMoveMoleculeFasterer {
    ...
    public MCMoveRotateArmFasterer(PotentialCompute potentialMaster, IRandom random, Box box, int armLength) {
        this(potentialMaster, random, box, 1.0, armLength);
    }

    public MCMoveRotateArmFasterer(PotentialCompute potentialMaster,
