...
public class StarPolymerMDFasterer extends Simulation {

    public Box box;
    public int f, l;
    public SpeciesGeneral species;
    public IntegratorVelocityVerletFasterer integratorMD;
    public P2Fene potentialFene;
    public P2WCA potentialWCA;
    public PotentialCompute potentialMaster;

    public StarPolymerMDFasterer(int f, int l, double temperature, double tStep, boolean useNbrs) {
        ...
        if (useNbrs) {
            potentialMasterPair = new PotentialMasterListFasterer(getSpeciesManager(), box, 1, 2, pmBonding.getBondingInfo());
        } else {
        ...
        integratorMD = new IntegratorVelocityVerletFasterer(potentialMaster, this.getRandom(), tStep, temperature, box);
        integratorMD.setIsothermal(true);
        integratorMD.setThermostat(IntegratorMDFasterer.ThermostatType.ANDERSEN);
    ...
    public static void main(String[] args) {
        StarPolymerMDFasterer.PolymerParam params = new StarPolymerMDFasterer.PolymerParam();
        if (args.length > 0) {
        ...
        final StarPolymerMDFasterer sim = new StarPolymerMDFasterer(f, l, temperature, tStep, useNbrs);

        final MeterPotentialEnergyFromIntegratorFasterer meterPE = new MeterPotentialEnergyFromIntegratorFasterer(sim.integratorMD);
