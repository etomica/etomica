...
public class FunctionPhilnparabolicpfouriersum  implements FunctionDifferentiable {
    ...
    public FunctionPhilnparabolicpfouriersum(double L,double aa0,double aa1,double aa2,double aa3,double aa4,double aa5,double aa6,double aa7,double aa8,double bb1,double bb2,double bb3,double bb4,double bb5,double bb6,double bb7,double bb8,double w) {
        this.L = L;
        this.w = w;
        this.aa0 = aa0;
        this.aa1 = aa1;
