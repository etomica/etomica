...
/**
 * Meter for calculating mapped averaging debye waller factor with one dimensional mapping
...
protected int numAtoms;
     ...
     */
    public MeterMappedAvgDebyeWallerr(int numAtoms, double[] qvector, double msd, Box box, PotentialMaster potentialMaster, double temperature, FunctionDifferentiable c, CoordinateDefinition latticesite) {
        this.box = box;
