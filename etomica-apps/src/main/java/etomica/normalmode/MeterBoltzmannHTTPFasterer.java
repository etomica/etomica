 ...
 *
 */
public class MeterBoltzmannHTTPFasterer implements IDataSource {

    protected final PotentialMasterFasterer potentialMaster, potentialMasterPretend;
    ...
    public MeterBoltzmannHTTPFasterer(PotentialMasterFasterer potentialMaster, ISpecies species, Simulation sim, CoordinateDefinition coordinateDefinition, double rc) {
        this.potentialMaster = potentialMaster;
        this.coordinateDefinition = coordinateDefinition;
        this.species = species;
        pretendBox = sim.makeBox(coordinateDefinition.getBox().getBoundary());
        potentialMasterPretend = new PotentialMasterListFasterer(sim.getSpeciesManager(),
