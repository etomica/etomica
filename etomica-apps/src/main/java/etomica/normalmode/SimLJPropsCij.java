...
//        ((MCMoveStepTracker)atomMove.getTracker()).setNoisyAdjustment(true);
    ...
    public static void main(String[] args) {
        ...
        //Sigma
        MeterPressureTensor meterSigma = new MeterPressureTensor(sim.potentialMaster, sim.space);
        meterSigma.setBox(sim.box);
        meterSigma.setTemperature(0);
//        meterSigma.getPotentialCalculation().setIntegrator(sim.integrator);
        IData dataSigma11_lat = meterSigma.getData();
        meterSigma.setTemperature(temperature);
...
//Initialization
	    ...
	    DataPumpListener accumulatorSigmaPump = new DataPumpListener(meterSigma, accumulatorSigma, interval);
...
/** RUN ... */       
        ...
        double sigma11_conv = density*temperature + dataUPAvg.getValue(10);
        double sigma11r = (numAtoms-1)/volume*temperature - dSigma11 +  + dataUPAvg.getValue(11);
        double sigma11r2 = -dSigma11 + dataUPAvg.getValue(12);
