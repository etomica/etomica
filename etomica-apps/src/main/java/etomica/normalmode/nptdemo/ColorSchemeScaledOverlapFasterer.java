 ...
 */
public class ColorSchemeScaledOverlapFasterer extends ColorSchemeCollectiveAgent {

    public ColorSchemeScaledOverlapFasterer(Space space, NeighborManager neighborManager, CoordinateDefinition coordinateDefinition) {
