...
public class HSNPT2DFastererGraphic extends SimulationGraphic {

    public double nominalScale;
    public DisplayBox displayBoxScaled;
    public HSNPT2DSimFasterer sim;
    protected final ColorScheme redColorScheme;
    protected final ColorSchemeOverlapFasterer colorSchemeOverlap;
    protected final ColorSchemeScaledOverlapFasterer colorSchemeScaled;

    public HSNPT2DFastererGraphic(HSNPT2DSimFasterer sim) {
        ...
        colorSchemeOverlap = new ColorSchemeOverlapFasterer(sim.getSpace(), sim.neighborManager, sim.box);
        getDisplayBox(sim.box).setColorScheme(colorSchemeOverlap);
        
        colorSchemeScaled = new ColorSchemeScaledOverlapFasterer(sim.getSpace(), sim.neighborManager, sim.coordinateDefinition);
    ...
    public static void main(String[] args) {
        HSNPT2DSimFasterer sim = new HSNPT2DSimFasterer();
        sim.getController().setSleepPeriod(1);
        HSNPT2DFastererGraphic graphic = new HSNPT2DFastererGraphic(sim);
