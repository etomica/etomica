 ...
 */
public class SimEinStep1Fasterer extends Simulation {
    ...
    public SimEinStep1Fasterer(Space _space, final int numAtoms, double density, final double temperature, double spring, int exponent, double rc, boolean slanty) {
        super(_space);
...
//        configEC.initializeCoordinates(box);
     ...
     * @see SimEinStep1Fasterer.SimOverlapParam
     */
...
//            params.spring = 5.694733676007302e+03;
        ...
        final SimEinStep1Fasterer sim = new SimEinStep1Fasterer(Space3D.getInstance(), numMolecules, density, temperature, spring, exponentN, rc, slanty);
