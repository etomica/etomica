...
public class MeterPIPrimTIA extends DataSourceScalar {
    protected final PotentialMasterBonding pmBonding;
    protected final PotentialComputeField pcP1;
    protected double betaN;
    protected int nBeads;

    public MeterPIPrimTIA(PotentialMasterBonding pmBonding, PotentialComputeField pcP1, double betaN, int nBeads) {
