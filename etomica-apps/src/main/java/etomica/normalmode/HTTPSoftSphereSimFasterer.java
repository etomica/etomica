 ...
 * @author Tai Boon Tan
 */
public class HTTPSoftSphereSimFasterer extends Simulation {

    public IntegratorMCFasterer integrator;
    protected PotentialMasterListFasterer potentialMaster;
    ...
    public HTTPSoftSphereSimFasterer(Space _space, int numAtoms, double temperature) {
        super(_space);
        ...
        MCMoveAtomCoupledFasterer atomMove = new MCMoveAtomCoupledFasterer(potentialMaster, getRandom(), space);
        ...
        if (potentialMaster instanceof PotentialMasterListFasterer) {
