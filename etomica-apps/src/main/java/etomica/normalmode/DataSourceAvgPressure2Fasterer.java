 ...
 */
public class DataSourceAvgPressure2Fasterer extends DataSourceScalar {
    ...
    protected DataSourceMuRootFasterer dsmr;

    public DataSourceAvgPressure2Fasterer(DataDistributer pSplitter, MCMoveOverlapListenerFasterer mcMoveOverlapMeter, double latticeDensity, double volume) {
    ...
    public void setDataSourceMuRoot(DataSourceMuRootFasterer dsmr) {
    	this.dsmr = dsmr;
    }
