...
public class MeterSolidDACutFasterer implements IDataSource {
    ...
    private final PotentialCalculationSolidSuperCutFasterer pc, pcDADv2;
    ...
    public MeterSolidDACutFasterer(Space space, PotentialCompute potentialMaster, CoordinateDefinition coordinateDefinition, double[] cutoffs) {
        ...
        pc = new PotentialCalculationSolidSuperCutFasterer(space, coordinateDefinition, cutoffs);
        pc.zeroSum();
        ...
        pcDADv2 = new PotentialCalculationSolidSuperCutFasterer(space, coordinateDefinition, cutoffs);
    }
