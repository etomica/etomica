 ...
 */
public class DataSourceAvgPressureFasterer extends DataSourceScalar {
    ...
    public DataSourceAvgPressureFasterer(DataDistributer pSplitter, MCMoveOverlapListenerFasterer mcMoveOverlapMeter, double bmu) {
