...
public class MeterPIHMATIA extends DataSourceScalar {
    ...
    public MeterPIHMATIA(PotentialMasterBonding pmBonding,  PotentialComputeField pcP1EnTIA, PotentialComputeField pcP1, double betaN, int nBeads, double omega2, Box box) {
