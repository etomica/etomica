...
public class MeterPIHMATIA extends DataSourceScalar {
    ...
    public MeterPIHMATIA(PotentialMasterBonding pmBonding,  PotentialComputeField pcP1EnTIA, PotentialComputeField pcP1, double betaN, int nBeads, double omega2, Box box, double hbar) {
    ...
    public double getDataAsScalar() {
        ...
        double En_HMA = 1.0/2.0/betaN + pcP1EnTIA.getLastEnergy() - pmBonding.getLastEnergy();
