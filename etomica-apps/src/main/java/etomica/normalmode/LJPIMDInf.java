...
//            params.facTimestep = 0.1;
        ...
        System.out.println(" LJ PIMDinf-"+coordType);
        ...
        MeterPICentVirInf meterCentVir = new MeterPICentVirInf(sim.pcP1harmPI, sim.pmAggAh, temperature, sim.box, nBeads, omega, hbar);
