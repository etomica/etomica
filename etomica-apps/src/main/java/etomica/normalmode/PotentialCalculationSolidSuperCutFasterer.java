 ...
 */
public class PotentialCalculationSolidSuperCutFasterer implements PotentialCallback {
    ...
    public PotentialCalculationSolidSuperCutFasterer(Space space, CoordinateDefinition coordinateDefinition, double[] cutoffs) {
