...
import etomica.integrator.mcmove.MCMoveInsertDeleteBiasedFasterer;
 ...
 */
public class DataSourceImposedFEHistogramFasterer implements IDataSource, DataSourceIndependent {
    ...
    protected final MCMoveInsertDeleteBiasedFasterer mcMoveID;

    public DataSourceImposedFEHistogramFasterer(MCMoveOverlapListenerFasterer mcMoveOverlapMeter, MCMoveInsertDeleteBiasedFasterer mcMoveID, double bmu) {
        tag = new DataTag();
        xTag = new DataTag();
