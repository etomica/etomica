...
public class LJVacancyMinFasterer extends Simulation {
    ...
    public LJVacancyMinFasterer(Space _space, int numAtoms, double density, double rc, boolean ss) {
        super(_space);
        ...
        potentialMaster = new PotentialMasterListFasterer(getSpeciesManager(), box, 7, rc, BondingInfo.noBonding());
    ...
    public static void main(String[] args) {
        ...
        final LJVacancyMinFasterer sim = new LJVacancyMinFasterer(Space.getInstance(3), numAtoms, density, rc*Math.pow(density, -1.0/3.0), ss);
        //start simulation
        MeterPressureFasterer meterP = new MeterPressureFasterer(sim.box, sim.potentialMaster);
