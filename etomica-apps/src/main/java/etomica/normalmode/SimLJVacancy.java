...
public class SimLJVacancy extends Simulation {
    ...
    public SimLJVacancy(final int numAtoms, double temperature, double density, double rc, final int numV, final double bmu, final boolean ss, boolean shifted) {
        ...
        integrator = new IntegratorMC(potentialCompute, random, temperature, box);
        MCMoveAtom move = new MCMoveAtom(random, potentialCompute, box);
...
//        ((MCMoveStepTracker)move.getTracker()).setNoisyAdjustment(true);
        ...
        mcMoveID = new MCMoveInsertDeleteLatticeVacancy(potentialCompute, neighborManager, random, space, integrator, y, numAtoms, numV);
    ...
    public static void main(String[] args) {
        ...
        final MeterPressure meterP = new MeterPressure(sim.box, sim.potentialCompute);
        ...
        if (graphics) {
            ...
            DataSourceMuRoot1 dsmr1 = new DataSourceMuRoot1(mcMoveOverlapMeter, mu, pSplitter, Double.NaN, density, numAtoms/density);
