 ...
 */
public class DataSourceFEHistogramFasterer implements IDataSource, DataSourceIndependent {
    ...
    public DataSourceFEHistogramFasterer(MCMoveOverlapListenerFasterer mcMoveOverlapMeter, double bmu) {
        tag = new DataTag();
        xTag = new DataTag();
