 ...
 */
public class DataSourceMuRootFasterer extends DataSourceScalar {
    ...
    public DataSourceMuRootFasterer(MCMoveOverlapListenerFasterer mcMoveOverlapMeter, double bmu, DataDistributer pSplitter, double bmuLat, double latticeDensity, double volume) {
    ...
    public class DataSourceMuRootPressure extends DataSourceScalar {
        ...
        public double getDataAsScalar() {
            DataSourceMuRootFasterer.this.getDataAsScalar();
            return DataSourceMuRootFasterer.this.getLastPressure();
        }
    }
    ...
    public class DataSourceMuRootDPressure extends DataSourceScalar {
        ...
        public double getDataAsScalar() {
            DataSourceMuRootFasterer.this.getDataAsScalar();
            return DataSourceMuRootFasterer.this.getLastDPressure();
        }
    }
    ...
    public class DataSourceMuRootDU extends DataSourceScalar {
        ...
        public double getDataAsScalar() {
            DataSourceMuRootFasterer.this.getDataAsScalar();
            return DataSourceMuRootFasterer.this.getLastDU();
        }
    }
    ...
    public class DataSourceMuRootVacancyConcentration extends DataSourceScalar {
        ...
        public double getDataAsScalar() {
            DataSourceMuRootFasterer.this.getDataAsScalar();
            return DataSourceMuRootFasterer.this.getLastVacancyConcentration();
        }
    }
}
