...
public class MeterPIHMAold extends DataSourceScalar {
    ...
    public MeterPIHMAold(PotentialMasterBonding pmBonding, PotentialComputeField pcP1, double betaN, int nBeads, double omega2, Box box) {
