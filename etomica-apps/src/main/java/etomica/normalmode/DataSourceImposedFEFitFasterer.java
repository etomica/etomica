 ...
 */
public class DataSourceImposedFEFitFasterer implements IDataSource, DataSourceIndependent {
    ...
    public DataSourceImposedFEFitFasterer(MCMoveOverlapListenerFasterer mcMoveOverlapMeter, MCMoveInsertDeleteBiasedFasterer mcMoveID, double bmu) {
        tag = new DataTag();
        xTag = new DataTag();
