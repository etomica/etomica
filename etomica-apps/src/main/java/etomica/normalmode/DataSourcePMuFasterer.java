 ...
 */
public class DataSourcePMuFasterer implements IDataSource, DataSourceIndependent {
    ...
    public DataSourcePMuFasterer(MCMoveOverlapListenerFasterer mcMoveOverlapMeter, double deltaBMu, int nMu, double bmu, DataDistributer pSplitter, double bALattice, double latticeDensity, double volume, boolean returnMu) {
        tag = new DataTag();
        xTag = new DataTag();
