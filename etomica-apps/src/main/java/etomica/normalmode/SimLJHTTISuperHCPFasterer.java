 ...
 */
public class SimLJHTTISuperHCPFasterer extends Simulation {
    ...
    public SimLJHTTISuperHCPFasterer(Space _space, int numAtoms, double density, double temperature, double alpha, double rc, boolean ss, int[] seeds) {
        super(_space);
        if (seeds != null) {
...
//        ((MCMoveStepTracker)atomMove.getTracker()).setNoisyAdjustment(true);
     ...
     * @see SimLJHTTISuperHCPFasterer.SimOverlapParam
     */
    public static void main(String[] args) {
        ...
        final SimLJHTTISuperHCPFasterer sim = new SimLJHTTISuperHCPFasterer(Space.getInstance(3), numAtoms, density, temperature, alpha, rc * Math.pow(density, -1.0 / 3.0), ss, seeds);
        if (seeds == null) {
