...
public class SimulationAlphaNitrogenModel extends Simulation{
	...
	public SimulationAlphaNitrogenModel(ISpace space, int numMolecule, double temperature, double pressure, double scale) {
		super(space);
		this.space = space;
	...
	public static void main (String[] args){
		...
		SimulationAlphaNitrogenModel sim = new SimulationAlphaNitrogenModel(Space3D.getInstance(3), numMolecule, temperature, pressure, scale);
...
//		sim.integrator.getEventManager().addListener(meterPressureListener);
		...
		System.out.println("Lattice Energy Sim: "+ meterPotentialEnergy.getDataAsScalar()/numMolecule);
