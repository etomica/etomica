...
public class TestMCMove extends Simulation {
    ...
    MCMoveCompareMultipleWVLoop move; 
...
//        convert.setConvertedWaveVector(2);
        ...
        move = new MCMoveCompareMultipleWVLoop(potentialMaster, random);
...
//        for(int i = 0; i < numAtoms; i++){
//            //one d is assumed here.
//            sim.locations[i] = ( ((AtomLeaf)leaflist.getAtom(i)).getPosition().get(0) );
