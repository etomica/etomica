 ...
 * @author cribbin
 */
public class TestMCMoveCompareSingleWV3DLJ extends Simulation {
    ...
    public TestMCMoveCompareSingleWV3DLJ(Space _space, int numAtoms, double density, double 
...
//        this.setRandom(rand);
        ...
        compareMove = new MCMoveCompareSingleWVLoop(potentialMaster, random);
        ...
        compareMove.setOmegaSquared(nm.getOmegaSquared(), nm.getWaveVectorFactory().getCoefficients());
...
//JOINT
    ...
    public static void main(String args[]){
        ...
        TestMCMoveCompareSingleWV3DLJ sim = new TestMCMoveCompareSingleWV3DLJ  (Space.getInstance(D), numMolecules,
