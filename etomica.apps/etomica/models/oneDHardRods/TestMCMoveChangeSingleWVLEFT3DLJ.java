 ...
 * @author cribbin
 */
public class TestMCMoveChangeSingleWVLEFT3DLJ extends Simulation {
    ...
    MCMoveChangeSingleWVLoopLEFT changeMove;

    public TestMCMoveChangeSingleWVLEFT3DLJ(Space _space, int numAtoms, double density, double 
...
//        this.setRandom(rand);
        ...
        changeMove = new MCMoveChangeSingleWVLoopLEFT(potentialMaster, random);
...
//JOINT
    ...
    public static void main(String args[]){
        ...
        TestMCMoveChangeSingleWVLEFT3DLJ sim = new TestMCMoveChangeSingleWVLEFT3DLJ  (Space.getInstance(D), numMolecules,
