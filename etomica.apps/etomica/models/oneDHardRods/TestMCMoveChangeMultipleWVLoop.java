...
public class TestMCMoveChangeMultipleWVLoop extends Simulation {
    ...
    public TestMCMoveChangeMultipleWVLoop(Space _space, int numAtoms, double density, double 
    ...
    public static void main(String[] args) {
        ...
        TestMCMoveChangeMultipleWVLoop sim = new TestMCMoveChangeMultipleWVLoop(Space.getInstance(D), numAtoms, density, temperature, filename, harmonicFudge);
