 ...
 * @author cribbin
 */
public class TestMCMoveChangeSingleWV3DLJ extends Simulation {
    ...
    public TestMCMoveChangeSingleWV3DLJ(Space _space, int numAtoms, double density, double 
...
//JOINT
    ...
    public static void main(String args[]){
        ...
        TestMCMoveChangeSingleWV3DLJ sim = new TestMCMoveChangeSingleWV3DLJ  (Space.getInstance(D), numMolecules,
