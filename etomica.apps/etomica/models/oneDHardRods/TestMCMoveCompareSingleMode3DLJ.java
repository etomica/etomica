 ...
 * @author cribbin
 */
public class TestMCMoveCompareSingleMode3DLJ extends Simulation {
    ...
    public TestMCMoveCompareSingleMode3DLJ(Space _space, int numAtoms, double density, double 
...
//JOINT
    ...
    public static void main(String args[]){
        ...
        TestMCMoveCompareSingleMode3DLJ sim = new TestMCMoveCompareSingleMode3DLJ  (Space.getInstance(D), numMolecules,
