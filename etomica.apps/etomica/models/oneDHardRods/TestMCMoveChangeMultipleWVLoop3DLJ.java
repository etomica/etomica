 ...
 * @author cribbin
 */
public class TestMCMoveChangeMultipleWVLoop3DLJ extends Simulation {
    ...
    public TestMCMoveChangeMultipleWVLoop3DLJ(Space _space, int numAtoms, double density, double 
...
//        this.setRandom(rand);
    ...
    public static void main(String args[]){
        ...
        TestMCMoveChangeMultipleWVLoop3DLJ sim = new TestMCMoveChangeMultipleWVLoop3DLJ  (Space.getInstance(D), numMolecules,
                density, temperature, filename, harmonicFudge, harmonicwvs);
