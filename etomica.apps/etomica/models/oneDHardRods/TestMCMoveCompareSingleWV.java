...
public class TestMCMoveCompareSingleWV extends Simulation {
    ...
    public static void main(String[] args) {
        ...
        TestMCMoveCompareSingleWV sim = new TestMCMoveCompareSingleWV(Space.getInstance(D), numAtoms, density, temperature, filename, harmonicFudge);
