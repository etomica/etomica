...
public class TestMCMoveChangeSingleWV extends Simulation {
    ...
    NormalModes1DHR nm;
    double[] locations;
    MCMoveChangeSingleWVLoop move;
    
    private static final String APP_NAME = "TestMCMove";
    

    public TestMCMoveChangeSingleWV(Space _space, int numAtoms, double density, double 
        ...
        move = new MCMoveChangeSingleWVLoop(potentialMaster, random);
    ...
    public static void main(String[] args) {
        ...
        TestMCMoveChangeSingleWV sim = new TestMCMoveChangeSingleWV(Space.getInstance(D), numAtoms, density, temperature, filename, harmonicFudge);
