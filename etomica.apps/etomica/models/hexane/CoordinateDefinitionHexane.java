...
public class CoordinateDefinitionHexane extends CoordinateDefinitionMolecule {
    ...
    public void calcU(IAtom[] molecule, double[] u) {
        ...
        IVector leafPos1 = ((AtomLeaf)((IAtomGroup)molecule[0]).getChildList().get(0)).getPosition();
        IVector leafPos2 = ((AtomLeaf)((IAtomGroup)molecule[0]).getChildList().get(1)).getPosition();
        IVector leafPos3 = ((AtomLeaf)((IAtomGroup)molecule[0]).getChildList().get(2)).getPosition();
