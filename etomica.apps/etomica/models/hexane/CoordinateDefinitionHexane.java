...
public class CoordinateDefinitionHexane extends CoordinateDefinitionMolecule {
    ...
    public void calcU(Atom[] molecule, double[] u) {
        ...
        IVector leafPos1 = ((AtomLeaf)((AtomGroup)molecule[0]).getChildList().get(0)).getPosition();
        IVector leafPos2 = ((AtomLeaf)((AtomGroup)molecule[0]).getChildList().get(1)).getPosition();
        IVector leafPos3 = ((AtomLeaf)((AtomGroup)molecule[0]).getChildList().get(2)).getPosition();
