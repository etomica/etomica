...
public class TestHexaneCompareConfigs extends Simulation {
    ...
    public TestHexaneCompareConfigs(Space space, double dens, int xCells, int yCells, int zCells) {
        super(space, false);
        ...
        //This here line here is what makes puts the atoms into place.
        coordinateDefinition.initializeCoordinates(nCells);

        //TEST HEXANE FROM FILE
        //Initialize the positions of the atoms.
        coordinateDefinition = new CoordinateDefinitionHexane(box, primitive, species);
        coordinateDefinition.initializeCoordinates(nCells);
    ...
    public static void main(String[] args) {
        ...
        TestHexaneCompareConfigs sim = new TestHexaneCompareConfigs(Space3D.getInstance(), density, xLng, yLng, zLng);
