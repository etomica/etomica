...
public class TestHexaneHigh100Small extends Simulation {
    ...
    public TestHexaneHigh100Small(Space space, int numMolecules) {
...
//            defaults.boxSize = 100;
    ...
    public static void main(String[] args) {
        ...
        TestHexaneHigh100Small sim = new TestHexaneHigh100Small(Space3D.getInstance(), numMolecules);
