...
public class TestHexaneHighSmall extends Simulation {
    ...
    public TestHexaneHighSmall(Space space, int numMolecules) {
...
//            defaults.boxSize = 100;
    ...
    public static void main(String[] args) {
        ...
        TestHexaneHighSmall sim = new TestHexaneHighSmall(Space3D.getInstance(), numMolecules);
