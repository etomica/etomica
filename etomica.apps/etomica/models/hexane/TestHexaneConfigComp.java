...
public class TestHexaneConfigComp extends Simulation {
...
//    public PairIndexerMolecule pri;
    ...
    public TestHexaneConfigComp(Space space, double dens, int xCells, int yCells, int zCells) {
...
//        writer.setBox(box);
//        writer.setConfName("hexBefStart");
//        writer.actionPerformed();
    ...
    public static void main(String[] args) {
        ...
        TestHexaneConfigComp sim = new TestHexaneConfigComp(Space3D.getInstance(), density, xLng, yLng, zLng);
