...
public class NormalCoordHexane extends NormalCoordMolecule {
    ...
    public void calcU(Atom molecule, int atomCount, double[] u) {
        ...
        Vector leafPos1 = ((AtomLeaf)((AtomTreeNodeGroup)molecule.getNode()).getChildList().get(0)).getCoord().getPosition();
        Vector leafPos2 = ((AtomLeaf)((AtomTreeNodeGroup)molecule.getNode()).getChildList().get(1)).getCoord().getPosition();
        Vector leafPos3 = ((AtomLeaf)((AtomTreeNodeGroup)molecule.getNode()).getChildList().get(2)).getCoord().getPosition();
