...
public class NormalCoordHexane extends NormalCoordMolecule {
    ...
    public void calcU(Atom molecule, int atomCount, double[] u) {
        ...
        Vector leafPos1 = ((AtomLeaf)((AtomTreeNodeGroup)molecule.node).childList.get(0)).coord.position();
        Vector leafPos2 = ((AtomLeaf)((AtomTreeNodeGroup)molecule.node).childList.get(1)).coord.position();
        Vector leafPos3 = ((AtomLeaf)((AtomTreeNodeGroup)molecule.node).childList.get(2)).coord.position();
