 ...
 *
 */
public class MCMoveHarmonicStepParacetamolOrthorhombic extends Simulation {
    ...
    public MCMoveHarmonicStepParacetamolOrthorhombic() {
        this(192);
    }
    
    private MCMoveHarmonicStepParacetamolOrthorhombic(int numMolecules) {
        ...
        moveHarmonicStep.setEigenVectors(normalModes.getEigenvectors(phase)[0]);
    ...
    public static void main(String[] args) {
        ...
        etomica.paracetamol.MCMoveHarmonicStepParacetamolOrthorhombic sim = new etomica.paracetamol.MCMoveHarmonicStepParacetamolOrthorhombic(numMolecules);
