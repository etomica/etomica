...
import etomica.conjugategradient.NonLinearConjugateGradients;
 ...
 */
public class TestCGParacetamolMinEnergy extends Simulation {

    public TestCGParacetamolMinEnergy(Space space, int numAtoms, double temperature) {
        super(space, true);
    ...
    public static void main(String[] args) {
        ...
        TestCGParacetamolMinEnergy sim = new TestCGParacetamolMinEnergy(Space.getInstance(3), nA, temperature);
