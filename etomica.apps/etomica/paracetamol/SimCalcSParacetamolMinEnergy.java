 ...
 */
public class SimCalcSParacetamolMinEnergy extends Simulation {

    public SimCalcSParacetamolMinEnergy(Space space, int numAtoms, double temperature) {
        super(space, true);
        ...
        coordinateDefinition = new CoordinateDefinitionParacetamol(phase, primitive, basis);
        coordinateDefinition.setBasisOrthorhombic();
        coordinateDefinition.initializeCoordinates(new int[]{2,3,4});
        ConfigurationFile configFile = new ConfigurationFile("Coord_Paracetamol_FormII_Minimum_Energy");
        configFile.initializeCoordinates(phase);
    ...
    public static void main(String[] args) {
        ...
        SimCalcSParacetamolMinEnergy sim = new SimCalcSParacetamolMinEnergy(Space.getInstance(3), nA, temperature);
        ...
        meterNormalMode.setBox(sim.phase);
...
//        configFile.initializeCoordinates(sim.phase);
        ...
        pdbWriter.setFileName("calcS_Min_Ortho_"+ Kelvin.UNIT.fromSim(temperature)+"_K.pdb");
