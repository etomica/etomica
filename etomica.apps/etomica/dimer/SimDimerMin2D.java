...
public class SimDimerMin2D extends Simulation {

	private static final long serialVersionUID = 1L;
	public ActivityIntegrate activityIntegrateDimerRT, activityIntegrateDimerMEP;
	public IntegratorDimerMin integratorDimerMEP;
	...
	public static void main(String[] args){
		...
		final SimDimerMin2D sim = new SimDimerMin2D();
	...
	public SimDimerMin2D() {
		...
		integratorDimerMEP = new IntegratorDimerMin(this, potentialMaster, new Species[]{species});
