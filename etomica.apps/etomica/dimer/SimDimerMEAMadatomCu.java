...
public class SimDimerMEAMadatomCu extends Simulation{
    ...
    public static void main(String[] args){
    	...
    	final SimDimerMEAMadatomCu sim = new SimDimerMEAMadatomCu();
    	
    	sim.activityIntegrateMD.setMaxSteps(10);
