...
public class SimDimer2D extends Simulation {
	...
	public static void main(String[] args){
		...
		final SimDimer2D sim = new SimDimer2D();
	...
	public SimDimer2D() {
		...
		integratorDimerRT = new IntegratorDimerRT(this, potentialMaster, new Species[]{species}, "2D");
