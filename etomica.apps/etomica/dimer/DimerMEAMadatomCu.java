...
public class DimerMEAMadatomCu extends Simulation{
    ...
    public static void main(String[] args){
    	...
    	final DimerMEAMadatomCu sim = new DimerMEAMadatomCu();
    	
    	sim.activityIntegrateMD.setMaxSteps(600);
    ...
    public DimerMEAMadatomCu() {
        ...
        integratorDimer = new IntegratorDimerRT(this, potentialMaster, new Species[]{cuAdatom, cu});     
    	activityIntegrateDimer = new ActivityIntegrate(integratorDimer);
    	        
    	integratorMEP = new IntegratorDimerMEP(this, potentialMaster, saddle, 10E-4, 10E-4, new Species[]{cuAdatom, cu});
