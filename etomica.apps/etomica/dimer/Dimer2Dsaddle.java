...
/**
 * Simulation using Henkelman's Dimer method to find a saddle point.
 * 
 * @author msellers
 *
 */

public class Dimer2Dsaddle extends Simulation {
	...
	public static void main(String[] args){
		final String APP_NAME = "Dimer2Dsaddle";
		final Dimer2Dsaddle sim = new Dimer2Dsaddle();
	...
	public Dimer2Dsaddle() {
		...
		integratorDimerRT = new IntegratorDimerRT(this, potentialMaster, new Species[]{species});
