...
public class SimDimerMEAMadatomSnGB extends Simulation{
    ...
    public static void main(String[] args){
    	final String APP_NAME = "DimerMEAMadatomSnGB";
    	final SimDimerMEAMadatomSnGB sim = new SimDimerMEAMadatomSnGB();
    	
    	sim.activityIntegrateMD.setMaxSteps(3000);
    ...
    public SimDimerMEAMadatomSnGB() {
        ...
        integratorDimer = new IntegratorDimerRT(this, potentialMaster, new Species[]{snAdatom, sn}, "SnGB");     
    	activityIntegrateDimer = new ActivityIntegrate(integratorDimer);
    	        
    	integratorMEP = new IntegratorDimerMin(this, potentialMaster, new Species[]{snAdatom, sn});
        ...
        //((IAtomPositioned)iAtom).getPosition().setX(0, 1.8*5.8314);
