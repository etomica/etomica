...
public class MeterDihedralAngle implements IAction, DataSource, DataSourceIndependent, java.io.Serializable {
        	...
        	for (int j=0; j<atomCount; j++){
        		...
        		for (int k=0; k<atomCount; k++){
            		...
            		for (int l=0; k<atomCount; k++){
            			...
            			workVector.Ea1Tv1(Math.sqrt(dr2.squared()), dr1);
            			dr2.XE(dr3);
            			dr1.XE(dr2);
            			double angle1 = Math.atan2(workVector.dot(dr2),dr1.dot(dr2));
	...
	public Data getData() {
        ...
        double norm = callCount * tetraNum;
    ...
    protected int callCount, tetraNum;
}
