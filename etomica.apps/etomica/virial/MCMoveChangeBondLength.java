...
//                dummy.setX(2, 0);
//        		for (int j=0; j<P; j++) {
//                    ((AtomHydrogen)atoms.getAtom(j)).setBondLength(r0);
//                    ((AtomHydrogen)atoms.getAtom(j)).getPosition().E(0);                    
//                    ((AtomHydrogen)atoms.getAtom(j)).getOrientation().setDirection(dummy);
//                }
//        	}
//        	dummy.E(0);
//        }
...
//                    uActNew2 += P1HydrogenMielke.vH2(jAtom.getBondLength());
//                    uActNew3 += kHarmonic*dist(jAtom,jPrev);
                ...
                for (int j=0; j<P; j++) {
                    newBL[j] = r0;                    
//                    if (i == 1 && moveCount == 0 && box.getIndex() == 0 && j == P/2) {
//                    	newBL[j] = 1.02*r0;
//                    }
                    for (int k=0; k<P; k++) {//mode = k, bondlength = j
...
//        if (moveCount == 0 && box.getIndex() == 0) {
//        	System.out.println("la = "+(uActNew3 - uActOld3));
//        	System.out.println("lb = "+(uActNew2 - uActOld2));
//        	System.out.println("lc = "+(uA1New - uA1Old)/(t*P));
//        	System.out.println("lhs = "+(uActNew - uActOld));
//        	System.exit(1);
//        }
        pRatio = Math.exp(uActOld - uActNew + uGenNew - uGenOld);
//        System.out.println("uActOld = "+uActOld+" uActNew = "+uActNew+" uGenOld = "+uGenOld+" uGenNew = "+uGenNew+" "+pRatio);
        ...
        moveCount++;
//        if (box.getIndex() == 1)System.out.print(Math.exp(-uGenNew)+" "+Math.exp(-uActNew)+"\n");
//        if (moveCount == 251) System.exit(1);
        return true;
    }
...
//            System.out.println("iter = "+i+" ,x0 = "+x0+" ,xNew = "+xNew+ " ,error = "+(x0-xNew)*(x0-xNew));
//            System.out.println("dvdr = "+dvdr+" d2v = "+d2vdr2+" "+P1HydrogenMielke.dvdr(x0)+" "+P1HydrogenMielke.d2vdr2(x0));            
