...
/**
 * Mayer sampling simulation for methanol using the multi-site unmodified Morse potential published in:
...
public class VirialRowleyMethanol {
    ...
    public static void main(String[] args) {
        ...
        ****************************************************************************
        ...
        - Rowley model WITHOUT point charges (unmodified Morse potential):
        ...
        The original units are:
       	...
       	Note: P2Morse takes alpha, a dimensionalness parameter, rather than A
        ...
        */
        ...
        P2Morse u_O_O   = new P2Morse(space, epsilon_O_O,   re_O_O,   A_O_O   );
        P2Morse u_O_aC  = new P2Morse(space, epsilon_O_aC,  re_O_aC,  A_O_aC  );
        P2Morse u_O_aH  = new P2Morse(space, epsilon_O_aH,  re_O_aH,  A_O_aH  );
        P2Morse u_O_H   = new P2Morse(space, epsilon_O_H,   re_O_H,   A_O_H   );
        
        P2Morse u_aC_aC = new P2Morse(space, epsilon_aC_aC, re_aC_aC, A_aC_aC );
        P2Morse u_aC_aH = new P2Morse(space, epsilon_aC_aH, re_aC_aH, A_aC_aH );
        P2Morse u_aC_H  = new P2Morse(space, epsilon_aC_H,  re_aC_H,  A_aC_H  );
        
        P2Morse u_aH_aH = new P2Morse(space, epsilon_aH_aH, re_aH_aH, A_aH_aH );
