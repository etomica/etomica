...
//            params.numSteps = (long)1E6;
//            params.cont = contribution.BOLTZMANN;
        }
        ...
        System.out.println("Contribution = "+cont);
...
//        ring regrow orientation
        ...
        if (nBeads != 1) {
            ...
            if (cont == contribution.EXCHANGE) {
                refOr.setDoExchange(true);
                tarOr.setDoExchange(true);
            }
        }
        else {
...
//        sim.printResults(HSB[nPoints]);        
    ...
    public static class VirialH2PISimpleParam extends ParameterBase {
        ...
        public contribution cont = contribution.BOLTZMANN;
