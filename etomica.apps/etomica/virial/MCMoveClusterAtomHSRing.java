...
//                return -rm7*rm7*(-1493730 + r*(-438893 + r*(558768 + r*(248955 + r*(37870 + r*(2625 + r*(84 + r)))))))/(630.*r*fac7);
            case 8:
                ...
                double rp4 = r + 4;
                double rp6 = r + 6;
                if(r<2) return ((153141527629013188608.0 + r*(-163596960124423372800.0 + 
                        r*(14747511968847888384.0 + r*(60513271259426979840.0 + 
                        r*(-40369464141382942720.0 + r*(11023547405143375872.0 + 
                        r*(-764298041732628480.0 + r*(-351356188071297024.0 + 
                        r*(103080234823188480.0 + r*(-9826226389647360.0 + 
                        r*(-115608799674368.0 + r*(96912135290880.0 + 
                        r*(-20166912589824.0 + r*(4715637104640.0 + 
                        r*(-1238313162240.0 + r*(-55403606016.0 + r*(22586847360.0 + 
                        r*(171908352 + r*(-111656160 + r*(-147840 + r*(195888 - 106*r*r))))))))))))))))
                                   )))) + Power(rm8,14)*(12893126400.0 + 
                          rm8*(6876334080.0 + rm8*(1504198080 + rm8*(176964480 + rm8*(12289200 + rm8*(517440 + rm8*(12936 + rm8*(176 + rm8)))))))) + 
                       Power(rp2,14)*(-722015078400.0 + rp2*(96268677120.0 + 
                             rp2*(6016792320.0 + rp2*(-1061786880 + Power(rp2,2)*(3104640 + rp2*(-51744 + rp2*(-2464 + 56*rp2))))))) + 
                       Power(rp4,14)*(-361007539200.0 + rp4*(96268677120.0 + 
                             rp4*(-6016792320.0 + rp4*(-353928960 + rp4*(49156800 + rp4*(-1034880 + rp4*(-51744 + (2464 - 28*rp4)*rp4))))))) + 
                       Power(rp6,14)*(-103145011200.0 + rp6*(41258004480.0 + 
                             rp6*(-6016792320.0 + rp6*(353928960 + Power(rp6,2)*(-1034880 + rp6*(51744 + rp6*(-1056 + 8*rp6))))))) + 
                       Power(rp8,14)*(-12893126400.0 + rp8*(6876334080.0 + 
                             rp8*(-1504198080 + rp8*(176964480 + rp8*(-12289200 + rp8*(517440 + rp8*(-12936 + (176 - rp8)*rp8))))))))/
                     (1.756251137152512e19*r))/fac8;
                if(r<4) return (153124691131961966592. + r*(-163482638077279600640. + 
                        r*(14389211769618825216. + r*(61199004746624532480. + r*(-41262331790654177280. + r*(11856698354543099904. + 
                        r*(-1334874019379281920. + r*(-63578528670547968. + r*(-1745755837562880. + r*(16059008947322880. + 
                        r*(-3589233681825792. + r*(-12713577676800. + r*(121001475538944. + r*(-18289011220480. + 
                        r*(-692790658560. + r*(203146555392. + r*(-143256960 + r*(-630330624 + r*(6320160 + r*(542080 + r*(-11088 + 6*r*r)))))
                        ))))))))))))))) + 
                       Power(rm8,14)*(12893126400. + rm8*(6876334080. + rm8*
                              (1504198080 + rm8*(176964480 + rm8*(12289200 + rm8*(517440 + rm8*(12936 + rm8*(176 + rm8)))))))) + 
                       Power(rp2,14)*(-722015078400. + rp2*(96268677120. + 
                             rp2*(6016792320. + rp2*(-1061786880 + Power(rp2,2)*(3104640 + rp2*(-51744 + rp2*(-2464 + 56*rp2))))))) + 
                       Power(rp4,14)*(-361007539200. + rp4*(96268677120. + 
                             rp4*(-6016792320. + rp4*(-353928960 + rp4*(49156800 + rp4*(-1034880 + rp4*(-51744 + (2464 - 28*rp4)*rp4))))))) + 
                       Power(rp6,14)*(-103145011200. + rp6*(41258004480. + 
                             rp6*(-6016792320. + rp6*(353928960 + Power(rp6,2)*(-1034880 + rp6*(51744 + rp6*(-1056 + 8*rp6))))))) + 
                       Power(rp8,14)*(-12893126400. + rp8*(6876334080. + 
                             rp8*(-1504198080 + rp8*(176964480 + rp8*(-12289200 + rp8*(517440 + rp8*(-12936 + (176 - rp8)*rp8))))))))/
                     (1.756251137152512e19*r);
                if(r<6) return (108294925306476625920. + r*(-29209878145919877120. + r*
                        (-164782532470442557440. + r*(199276796979991019520. + 
                                r*(-106818647716108697600. + r*(29703877630598578176. + 
                                      r*(-2561986971995996160. + r*(-1117753026325512192. + 
                                            r*(454600486724567040. + r*(-69737689833799680. + 
                                                  r*(1644861490528256. + 
                                                     r*(1124804890460160. + 
                                                        r*(-161335300718592. + 
                                                           r*(1720611594240. + 
                                                              r*(382209569280. + 
                                                                r*(-55403606016. + 
                                                                r*(9216197760. + 
                                                                r*(171908352 + r*(-52668000 + r*(-147840 + r*(92400 - 50*r*r)))))))))))))))))))
                          ) + Power(rm8,14)*(12893126400. + rm8*(6876334080. + 
                             rm8*(1504198080 + rm8*(176964480 + rm8*(12289200 + rm8*(517440 + rm8*(12936 + rm8*(176 + rm8)))))))) + 
                       Power(rp2,14)*(-722015078400. + rp2*(96268677120. + 
                             rp2*(6016792320. + rp2*(-1061786880 + Power(rp2,2)*(3104640 + rp2*(-51744 + rp2*(-2464 + 56*rp2))))))) + 
                       Power(rp4,14)*(-361007539200. + rp4*(96268677120. + 
                             rp4*(-6016792320. + rp4*(-353928960 + rp4*(49156800 + rp4*(-1034880 + rp4*(-51744 + (2464 - 28*rp4)*rp4))))))) + 
                       ...
                       Power(rp8,14)*(-12893126400. + rp8*(6876334080. + 
                             rp8*(-1504198080 + rp8*(176964480 + rp8*(-12289200 + rp8*(517440 + rp8*(-12936 + (176 - rp8)*rp8))))))))/
                     (1.756251137152512e19*r);
                return (-153141527629013188608. + r*(163596960124423372800. + 
                        r*(-14747511968847888384. + r*(-60513271259426979840. + 
                                r*(40369464141382942720. + r*(-11023547405143375872. + 
                                      r*(764298041732628480. + r*(351356188071297024. + 
                                            r*(-103080234823188480. + r*
                                                (9826226389647360. + r*(115608799674368. + 
                                                     r*(-96912135290880. + 
                                                        r*(20166912589824. + 
                                                           r*(-4715637104640. + 
                                                              r*(-566724533760. + 
                                                                r*(55403606016. + 
                                                                r*(7497114240. + 
                                                                r*(-171908352 + r*(-35814240 + r*(147840 + r*(62832 - 34*r*r)))))))))))))))))))
                          ) + Power(rm8,14)*(12893126400. + rm8*(6876334080. + 
                             rm8*(1504198080 + rm8*(176964480 + rm8*(12289200 + rm8*(517440 + rm8*(12936 + rm8*(176 + rm8)))))))) + 
                       Power(rp2,14)*(-722015078400. + rp2*(96268677120. + 
                             rp2*(6016792320. + rp2*(-1061786880 + Power(rp2,2)*(3104640 + rp2*(-51744 + rp2*(-2464 + 56*rp2))))))) + 
    ...
    protected final static double fac8 = -8192*(-1846795758* + 468503*ArcCoth(3) + 1247929879*ArcCoth(5) + 8522825728.0*ArcCoth(7))/2.001737863125e12;
