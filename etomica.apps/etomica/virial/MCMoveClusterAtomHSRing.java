...
//                        )/(630.*r*fac7);
            ...
            case 8:
                double rm8 = r - 8;
                double rm82 = rm8*rm8;
                if(r<2) return (153141527629013188608. + r*(-155523739327901204480. + 
                        r*(14747511968847888384. + r*(58210431673313525760. + 
                                r*(-40369464141382942720. + r*(11340249109572354048. + 
                                      r*(-764298041732628480. + r*(-379367837732438016. + 
                                            r*(103080234823188480. + r*(-8029504473661440. + 
                                                  r*(-115608799674368. + 
                                                     r*(6356788838400. + 
                                                        r*(-20166912589824. + 
                                                           r*(9144505610240. + 
                                                              r*(-787053738240. + 
                                                                r*(-101573277696. + 
                                                                r*(15065856960. + 
                                                                r*(315165312 + r*(-74788560 + r*(-271040 + r*(131208 - 71*r*r))))))))))))))))))
                             )) + Power(rm82,7)*(12893126400. + rm8*(6876334080. + 
                             rm8*(1504198080 + rm8*(176964480 + rm8*(12289200 + rm8*(517440 + rm8*(12936 + rm8*(176 + rm8)))))))))/(r*fac8);
                if(r<4) return (1.5312469113196197e20 + r*(-1.5540941728075743e20 + 
                        r*(1.4389211769618825e19 + r*(5.889616516051108e19 + 
                                r*(-4.126233179065418e19 + r*(1.2173400058972078e19 + 
                                      r*(-1.334874019379282e18 + r*(-9.159017833168896e16 + 
                                            r*(-1.74575583756288e15 + r*
                                                (1.78557308633088e16 + 
                                                  r*(-3.589233681825792e15 + 
                                                     r*(-1.0326892412928e14 + 
                                                        r*(1.21001475538944e14 + 
                                                           r*(-1.386014271488e13 + 
                                                              r*(-2.4153123456e11 + 
                                                                r*(1.56976883712e11 + 
                                                                r*(-7.66424736e9 + 
                                                                r*(-4.87073664e8 + r*(4.318776e7 + r*(418880. + r*(-75768. + 41.*r*r)))))))))))
                                                  ))))))))) + Power(rm82,7)*
                        (1.28931264e10 + rm8*(6.87633408e9 + rm8*(1.50419808e9 + 
                                rm8*(1.7696448e8 + rm8*(1.22892e7 + rm8*(517440. + rm8*(12936. + rm8*(176. + rm8)))))))))/(fac8*r);
                if(r<6) return (1.0829492530647663e20 + r*(-2.113665734939771e19 + r*
                        (-1.6478253247044256e20 + r*(1.9697395739387757e20 + 
                                r*(-1.068186477161087e20 + r*(3.0020579335027556e19 + 
                                      r*(-2.561986971995996e18 + r*(-1.1457646759866532e18 + 
                                            r*(4.5460048672456704e17 + 
                                               r*(-6.794096791781376e16 + 
                                                  r*(1.644861490528256e15 + 
                                                     r*(1.03424954400768e15 + 
                                                        r*(-1.61335300718592e14 + 
                                                           r*(6.14948009984e12 + 
                                                              r*(8.3346899328e11 + 
                                                                r*(-1.01573277696e11 + 
                                                                r*(1.69520736e9 + 
                                                                r*(3.15165312e8 + r*(-1.58004e7 + r*(-271040. + r*(27720. - 15.*r*r))))))))))))
                                               )))))))) + Power(rm82,7)*
                        (1.28931264e10 + rm8*(6.87633408e9 + rm8*(1.50419808e9 + 
                                rm8*(1.7696448e8 + rm8*(1.22892e7 + rm8*(517440. + rm8*(12936. + rm8*(176. + rm8)))))))))/(fac8*r);
                return (-1.531415276290132e20 + r*(1.7167018092094554e20 + r*
                        (-1.4747511968847888e19 + r*(-6.281611084554043e19 + 
                                r*(4.036946414138294e19 + r*(-1.0706845700714398e19 + 
                                      r*(7.642980417326285e17 + r*(3.23344538410156e17 + 
                                            r*(-1.0308023482318848e17 + 
                                               r*(1.162294830563328e16 + 
                                                  r*(1.15608799674368e14 + 
                                                     r*(-1.8746748174336e14 + 
                                                        r*(2.0166912589824e13 + 
                                                           r*(-2.8676859904e11 + 
                                                              r*(-1.1546510976e11 + 
                                                                r*(9.233934336e9 + 
                                                                r*(-2.387616e7 + 
                                                                r*(-2.8651392e7 + r*(1.05336e6 + r*(24640. + r*(-1848. + r*r)))))))))))))))))))
                          ) + Power(rm82,7)*(1.28931264e10 + rm8*(6.87633408e9 + 
                             rm8*(1.50419808e9 + rm8*(1.7696448e8 + rm8*(1.22892e7 + rm8*(517440. + rm8*(12936. + rm8*(176. + rm8)))))))))/(fac8*r);
