...
public class PhaseCluster extends Phase {
	...
	public PhaseCluster(Simulation sim, ClusterWeight cluster) {
        ...
        setBoundary(new BoundaryRectangularNonperiodic(sim.getSpace()));
	}
    ...
    public void trialNotify() {
        ...
        if(cPairSet == null) {
            // assume 1 species
            AtomArrayList molecules = ((AtomTreeNodeGroup)((AtomTreeNodeGroup)getSpeciesMaster().getNode()).getChildList().get(0).getNode()).getChildList();
