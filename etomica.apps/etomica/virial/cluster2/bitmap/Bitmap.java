...
/**
 * Abstracts away the form in which bitmaps implement their operations and store
 * their data.
 * 
 * @author Demian Lessa
 */
public interface Bitmap extends Comparable<Bitmap> {
  ...
  public static byte SZ_LONG = 64;

  /**
   * Updates this bitmap with the result of the bitwise AND with the other
   * bitmap: bitmap = (bitmap & other). Assumes the bit length of the other
   * bitmap is AT LEAST as large as the bit length of this bitmap.
   * 
   */
  ...
  /**
   * Returns a bitmap instance with the same number of bits as this bitmap. If
   * other has fewer bits than this bitmap, the output bitmap is 0-padded and
   * has the same integer value as other. If other has more bits than this
   * bitmap, the output bitmap is the result of truncating the highest bits of
   * other.
   * 
  ...
  /**
   * Creates an instance-compatible copy of this bitmap. This bitmap and the
   * returned bitmap are both instances of the same class.
   * 
   * @return copy of the this bitmap
   */
  public Bitmap copy();
   ...
   * This bitmap and the returned bitmap are both instances of the same class.
   * 
   * @return copy of the this bitmap
   */
