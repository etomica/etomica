 ...
 * @author andrew
 */
public class ClusterDiagram2 implements java.io.Serializable {
    
    public final int mNumBody;
    public final int[][] mConnections;    // mNumBody*mNumBody*sizeOf(int) bits 
     ...
     */
    public ClusterDiagram2(int numBody, int numRootPoints) {
     ...
     */
    public ClusterDiagram2(int numBody, int numRootPoints, int[][] bonds) {
        this(numBody, numRootPoints, bonds, new Rational(1,1));
    }
    
    public ClusterDiagram2(int numBody, int numRootPoints, int[][] bonds, Rational weight) {
        mNumBody = numBody;
     ...
     */
    public ClusterDiagram2(ClusterDiagram2 cluster) {
        this(cluster.mNumBody, cluster.mNumRootPoints);
        cluster.copyTo(this);
    }

    public void copyTo(ClusterDiagram2 destCluster) {
     ...
     * field points.
     */
    public boolean isIsomorphOf(ClusterDiagram2 anotherCluster) {
        ...
        ClusterGenerator2.findMaxScore(excludeRootPermutations, this, score);
        ClusterGenerator2.findMaxScore(excludeRootPermutations, anotherCluster, anotherScore);
        setWeight(weight);
    ...
    public static void main(String[] args) {
        int n = 4;
        ClusterDiagram2 cluster = new ClusterDiagram2(n,0);
//        int[] array = new int[] {};
...
//        System.exit(1);
        ...
        ClusterGenerator2 cg = new ClusterGenerator2(cluster);
        cg.isMaximumScore();
