...
public class P1Constraint extends Potential1{
	...
	public P1Constraint(ISpace space, Primitive primitive, IBox box, CoordinateDefinition coordinateDefinition) {
		...
		IVector distance = space.makeVector();
		neighborSite = new IVector[siteIndex][siteIndex];
	...
	public double energy(IAtomSet atoms) {
		...
		int atomIndex = ((IAtomLeaf)atoms.getAtom(0)).getLeafIndex();
	...
	private IVector[] latticeSite; 
	private IVector[][] neighborSite;
