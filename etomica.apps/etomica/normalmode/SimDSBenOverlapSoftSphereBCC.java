...
public class SimDSBenOverlapSoftSphereBCC extends Simulation {
    ...
    public SimDSBenOverlapSoftSphereBCC(Space _space, int numAtoms, double density, double temperature, String filename, double harmonicFudge, int exponent) {
        super(_space, true);
...
//        }
    ...
    public void initRefPref(String fileName, long initSteps) {
        ...
        if (refPref == -1) {
            ...
            System.out.println("***Ref pref: "+ refPref);
     ...
     * @see SimDSBenOverlapSoftSphereBCC.SimOverlapParam
     */
    public static void main(String[] args) {
        ...
        final SimDSBenOverlapSoftSphereBCC sim = new SimDSBenOverlapSoftSphereBCC(Space.getInstance(D), numMolecules, density, temperature, filename, harmonicFudge, exponentN);
