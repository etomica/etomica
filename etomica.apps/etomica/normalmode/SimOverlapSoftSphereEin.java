...
//      ((MCMoveStepTracker)atomMove.getTracker()).setNoisyAdjustment(true);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("average delta U "+accumulator.getData().getValue(AccumulatorAverage.StatType.AVERAGE.index)+" "+accumulator.getData().getValue(AccumulatorAverage.StatType.ERROR.index)+" "+accumulator.getData().getValue(AccumulatorAverage.StatType.BLOCK_CORRELATION.index));
