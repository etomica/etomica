...
public interface NormalCoordMapper {
    ...
    /**
     * Returns the number of normal mode coordinate dimensions needed for each
     * molecule
     */
    ...
    /**
     * Calculates the U displacements for the given atom relative to its perfect
     * lattice value.
     * 
     * @param atom
     *            The atom of interest
     * @param nominalU
     *            The atom's nominal coordinates, from an earlier call to
     *            initNominalU
     * @param u
     *            Upon return, the atom's deviation from its perfect lattice
