...
public class SimCalcSSoftSphereFCC extends Simulation {
    ...
    public SimCalcSSoftSphereFCC(Space _space, int numAtoms, double density, double temperature, double softness) {
        super(_space, true);
    ...
    public static void main(String[] args) {
        ...
        String filename = "nm_SoftSphere_" + softness + "S_"+temperature+"T";
        if (args.length > 0) {
            filename = args[0];
        }
        ...
        SimCalcSSoftSphereFCC sim = new SimCalcSSoftSphereFCC(Space.getInstance(D), nA, density, temperature, softness);
