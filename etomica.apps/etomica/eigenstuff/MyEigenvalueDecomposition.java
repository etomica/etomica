...
// Based on jama.EigenvalueDecomposition.java; modified to take data from a
// file as a DataDoubleArray, rather than use a matrix
public class MyEigenvalueDecomposition implements java.io.Serializable {
    ...
    */
    ...
    public MyEigenvalueDecomposition(int n, double[][] input) {
        this.n = n;
