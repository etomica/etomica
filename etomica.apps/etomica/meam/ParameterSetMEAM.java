...
public class ParameterSetMEAM {
	...
	public static final ParameterSetMEAM Cu = new ParameterSetMEAM(ElectronVolt.UNIT.toSim(3.540), 1.07, 2.56, 5.11, 3.63, 2.2, 6.0, 2.2, 3.14, 2.49, 2.95, 1.0, 12.0, 2.0, 2.8);
