...
public class SimOverlapMultiHarmonicOptRefPref extends Simulation{
	...
	public static void main(String[] args){
        ...
        System.out.println("System-A ratio average: "+((DataDoubleArray)allYourBase.getData(AccumulatorAverage.StatType.AVERAGE.index)).getData()[1]
        ...
        System.out.println("System-B ratio average: "+((DataDoubleArray)allYourBase.getData(AccumulatorAverage.StatType.AVERAGE.index)).getData()[1]
                          +" stdev: "+((DataDoubleArray)allYourBase.getData(AccumulatorAverage.StatType.STANDARD_DEVIATION.index)).getData()[1]
                          +" error: "+((DataDoubleArray)allYourBase.getData(AccumulatorAverage.StatType.ERROR.index)).getData()[1]);
         ...
         */
        double betaUAB = dataAverageA.getData().getValue(AccumulatorAverage.StatType.AVERAGE.index);
        double betaUBA = dataAverageB.getData().getValue(AccumulatorAverage.StatType.AVERAGE.index);
