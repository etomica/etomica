...
public class PistonCylinder extends Simulation {
    ...
    public P2SimpleWrapper p2DiskWall;
    public PotentialHardDisk potential;
    public PotentialHardDiskWall potentialHardDiskWall;
    ...
    public PistonCylinder() {
	    ...
	    potentialHardDiskWall = new PotentialHardDiskWall();
//        P2DiskWall p2DiskWall = new P2DiskWall();
	    p2DiskWall = new P2SimpleWrapper(this,potentialHardDiskWall);
