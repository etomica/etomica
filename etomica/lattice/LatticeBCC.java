...
public class LatticeBCC extends LatticeCubic {
    
    private static double latticeConstant = 15.0;
    public LatticeBCC(){
    ...
    public static Space3D.Vector [] positions(){
        Space3D.Vector[] p = new Space3D.Vector[2];
        for(int i=0; i<2; i++) {
