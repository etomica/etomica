 ...
 */
public final class Atom2 {
    public static String getVersion() {return "01.06.12";}

    public AtomGroup atom1, atom2;
    public final Space.CoordinatePair cPair;
//    public Potential potential;
   /**
    * Constructs and AtomPair for the given phase, but with no designated atoms.
    */
    public Atom2(Phase phase) {
     ...
     */
    public Atom2(Atom a1, Atom a2) {  //Assumes a1 and a2 are in same phase
     ...
     * The method atom1() will return the first atom in the argument list here, and atom2() the second.
     */
    public Atom2(Atom a1, Atom a2, Space.CoordinatePair c) {atom1 = a1; atom2 = a2; cPair = c;}
     ...
     */
    public Atom2 copy() {
        return new Atom2(atom1, atom2, cPair.copy());  //cannot use super.clone() because cPair (being final) cannot then be changed to a clone of cPair
    }
