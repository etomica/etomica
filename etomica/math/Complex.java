...
public class Complex extends Object {
	...
	public Complex plus(Complex w) {
		return new Complex(x+w.real(),y+w.imagine());
	}
	...
	public Complex times(Complex w) {
		return new Complex(x*w.real()-y*w.imagine(),x*w.imagine()+y*w.real());
	}
	...
	public Complex div(Complex w) {
		...
		return new Complex((x*w.real()+y*w.imagine())/den,(y*w.real()-x*w.imagine())/den);
	}
