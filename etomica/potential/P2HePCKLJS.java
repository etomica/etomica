...
public class P2HePCKLJS extends Potential2SoftSpherical {
    ...
    */
    ...
    public static void main(String[] args) {
    	...
    	for (int i=0;i<100;i++) {
    		double r = i*0.1;
    		double u12 = p2.u(r*r*AngstromPerBohrRadius*AngstromPerBohrRadius); // Kelvin
    		double u23 = p2.u(2.0*r*2.0*r*AngstromPerBohrRadius*AngstromPerBohrRadius); // Kelvin
    		System.out.println(r+" "+(u12+u12+u23));
    	}
    }
