...
public class P3CPSNonAdditiveHe extends Potential implements PotentialSoft {
    ...
    protected double energy(double RAB, double RAC, double RBC, double costhetaA, double costhetaB, double costhetaC) {
        ...
        */
        ...
        return Hartree.UNIT.toSim(Vexp+V3disp+V4disp);
    ...
    public static void main(String[] args) {
        // differences from fortran primarily due to unit conversions
        ...
        double a; double U; IVectorMutable r0; IVectorMutable r1; IVectorMutable r2;
        ...
        System.out.println("here    : " + Kelvin.UNIT.fromSim(U)*1000+ " mK");
