...
public class IntegratorDimerApproach extends IntegratorBox {
	...
	public void initializeCoordinates() {
        ...
        double yaw   =   routeParams[0][0]*Math.PI/180;
	...
	public void doStepInternal() {
		...
		// to avoid rescaling PE plot and bothering with NaNs
		
		// The value of r at which the potential energy becomes order 10.
		double liftOff = routeParams[5][0];
	...
	public void setImportantAtoms() {
	    ...
	    atom_aH_A = (IAtomPositioned) atomSetA.getAtom(3);
	    ...
	    atom_aH_B = (IAtomPositioned) atomSetB.getAtom(3);
