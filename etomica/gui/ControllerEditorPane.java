...
public class ControllerEditorPane extends SimulationEditorPane {
    ...
    ControllerEditorPane(){
        ...
        // selected radioButton to the Simulation.instance object as well as to the controllerEditorPane's
        // componentList.  
	    ...
	    remove.addActionListener(new MyActionListener(){
	        public void actionPerformed(ActionEvent e){
                Simulation.instance.unregister(((Controller)componentList.getElementAt(getCurrentSelection())));
