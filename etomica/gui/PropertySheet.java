...
public class PropertySheet extends JInternalFrame {
    ...
    static {
        ...
        PropertyEditorManager.registerEditor(etomica.DatumSource.class, etomica.DatumSourceEditor.class);
//        PropertyEditorManager.registerEditor(etomica.MCMove[].class, etomica.gui.McMoveEditor.class);
    ...
    public PropertySheet(SimulationElement element, int x, int y) {
     ...
     */
    public void setTarget(SimulationElement element) {
        setSize(250,300);///
...
class PropertySheetPanel extends JPanel {
     ...
     */
    synchronized void setTarget(SimulationElement e) {
        updateThread.clear();
...
///        groups = new java.util.Vector();
	    ...
	    elementCombo.addItemListener(new java.awt.event.ItemListener() {
	        public void itemStateChanged(java.awt.event.ItemEvent ie){
	            SimulationElement item = (SimulationElement)((JComboBox)ie.getSource()).getSelectedItem();
    ...
    synchronized void wasModified(PropertyChangeEvent evt) {
	    ...
	    if (evt.getSource() instanceof PropertyEditor) {
            ...
            for(java.util.Enumeration enum = root.breadthFirstEnumeration(); enum.hasMoreElements();) {
		        ...
		        JavaWriter javaWriter = (JavaWriter)Etomica.javaWriters.get(target.parentSimulation());
                javaWriter.propertyChange(((PropertyNode)node.getParent()).object(), setter, editor.getJavaInitializationString());
...
*/    
    ...
    // time.
    private SimulationElement target;
