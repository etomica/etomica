...
public class IntegratorEditorPane extends SimulationEditorPane {
    ...
    IntegratorEditorPane(){
        ...
        // selected radioButton to the Simulation.instance object as well as to the integratorEditorPane's
        // componentList.  
        addToSim.addActionListener(new MyActionListener(){
                public void actionPerformed(ActionEvent e){
	                ...
	                try {   // Try to make an instance of the selected class
	                    ...
	                    ((Integrator)getComponent()).setName(((Class)currentButton.cls).getName().substring(9) + Integer.toString(IDnumber++));
	    ...
	    remove.addActionListener(new MyActionListener(){
	        public void actionPerformed(ActionEvent e){
                Simulation.instance.unregister(((Integrator)componentList.getElementAt(getCurrentSelection())));
