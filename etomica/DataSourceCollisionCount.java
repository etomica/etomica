...
/**
 * This is a data source to count the number of collisions processed by a hard-potential
 * integrator.
 */

public class DataSourceCollisionCount extends DataSourceAdapter {
    
    public DataSourceCollisionCount(Simulation sim) {
