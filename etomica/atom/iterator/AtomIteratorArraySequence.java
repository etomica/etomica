 ...
 */
public class AtomIteratorArraySequence implements AtomIteratorAtomDependent, java.io.Serializable {
     ...
     * iteration.
     */
    public AtomIteratorArraySequence(IteratorDirective.Direction direction) {
        this(direction, 0);
    }

    public AtomIteratorArraySequence(IteratorDirective.Direction direction, int numToSkip) {
        this(direction, numToSkip, new AtomToIndexOrdinal());
    }
    ...
    private final AtomToIndex atomToLinker;
