...
/**
 * Iterator for the molecules in a phase. Loops over those atoms that lie just
 * below the species agents in the atom tree hierarchy. Can be set to loop over
 * all molecules in a phase, or only those for a given species.
 * 
 * @author David Kofke
 * @since 02.02.16
 */

public final class AtomIteratorMolecule extends AtomIteratorAdapter implements
		AtomsetIteratorSpeciesDependent, AtomIteratorSpeciesDependent {
