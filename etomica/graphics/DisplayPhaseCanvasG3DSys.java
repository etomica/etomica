...
public class DisplayPhaseCanvasG3DSys extends DisplayCanvas implements
	...
	/**
	 * refreshAtomAgentMgr() - sets the new atom manager based upon the phase.
	 *    Would only need to be called if it's DisplayPhases' phase has changed.
	 *
	 */
...
*/
		...
		// If displaying a new phase, make it fit on the screen
	...
	public Object makeAgent(IAtom a) {
		...
		Ball newBall = new Ball(gsys, G3DSys.getColix((displayPhase
