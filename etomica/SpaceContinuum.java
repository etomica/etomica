...
public class SpaceContinuum extends Component {
  ...
  */
    protected final SpaceVector dimensions = new SpaceVector();
    
    private final SpaceVector work = new SpaceVector();       //temporary work vector
  ...
  */
    ...
    */
    ...
    private class ContinuumCoordinate implements Coordinate {
        public SpaceVector q = new SpaceVector();
        public SpaceVector p = new SpaceVector();
    }
    
    private class SpaceVector2 implements SpaceVector {
        double x = 0.0;
        double y = 0.0;
    }
    
    public Coordinate makeCoordinate() {
        return new ContinuumCoordinate();
    }
    public SpaceVector makeSpaceVector() {
        return new SpaceVector2();
    }
